...
const WebDevelopmentComponent = () => {
  ...
  const servicePageMap = {
    ...
    "pos": "/services/pos-development",
    "custom": "/services/custom-web-development",
  };

  const handleNavigation = (key) => {
    const destination = servicePageMap[key] || "/web-design";
    router.push(destination);
  };
  
  // Default service data (fallback if no data from Supabase)
  const defaultServices = [
    ...
    },
    {
      key: 'pos',
      name: 'Point Of Sale',
      description: 'Smart POS systems built for fast and easy sales.',
  ...
  // Default text content (fallback)
  const defaultContent = {
    section1_heading: 'Web Development',
    section2_heading: 'Tailored For Clients Needs',
    section_description: 'From popular platforms to custom builds — we develop solutions that fit your business perfectly.'
  };
  ...
  // Create services array with either Supabase data or defaults
  const services = React.useMemo(() => {
    if (!pageData) return defaultServices;
    
    return [
      {
        ...defaultServices[0],
        name: pageData.card1_title || defaultServices[0].name,
        description: pageData.card1_description || defaultServices[0].description
      },
      {
        ...defaultServices[1],
        name: pageData.card2_title || defaultServices[1].name,
        description: pageData.card2_description || defaultServices[1].description
      },
      {
        ...defaultServices[2],
        name: pageData.card3_title || defaultServices[2].name,
        description: pageData.card3_description || defaultServices[2].description
      },
      {
        ...defaultServices[3],
        name: pageData.card4_title || defaultServices[3].name,
        description: pageData.card4_description || defaultServices[3].description
      }
    ];
  }, [pageData]);

  // Determine content text based on data availability
  const contentText = React.useMemo(() => {
    if (!pageData) return defaultContent;
    
    return {
      section1_heading: pageData.section1_heading || defaultContent.section1_heading,
      section2_heading: pageData.section2_heading || defaultContent.section2_heading,
      section_description: pageData.section_description || defaultContent.section_description
    };
  }, [pageData]);
  ...
  return (
    <>
      <Head>
        <title>Professional Web Development Services | WordPress, Shopify & Custom Solutions</title>
        <meta name="description" content="Expert web development services tailored to your business needs. We specialize in WordPress, Shopify, Point of Sale systems, and custom development solutions." />
        <meta name="keywords" content="web development, wordpress development, shopify development, ecommerce website, custom web development, point of sale systems, professional web services" />
        
        {/* Open Graph Tags for better social sharing */}
        <meta property="og:title" content="Web Development Services | WordPress, Shopify & Custom Solutions" />
        <meta property="og:description" content="Expert web development services tailored for your business needs. Specialized in WordPress, Shopify, POS and custom solutions." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://kinsebwebdevelopment/web-development" />
        <meta property="og:image" content="https://kinsebwebdevelopment/images/web-development-og.jpg" />
        
        {/* Twitter Card data */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Professional Web Development Services" />
        <meta name="twitter:description" content="WordPress, Shopify, POS and custom development solutions tailored for your business needs." />
        <meta name="twitter:image" content="https://kinsebwebdevelopment/images/web-development-twitter.jpg" />
        
        {/* Canonical URL to prevent duplicate content issues */}
        <link rel="canonical" href="https://kinsebwebdevelopment/web-development" />
      ...
      <div style={containerStyle}>
        ...
        <div style={headerStyle}>
          ...
          }}>{contentText.section1_heading}</h1>
          <h2 style={{
            ...subtitleStyle,
            textAlign: isMobile ? 'left' : 'center',
          }}>
            {contentText.section2_heading.split(' ').map((word, i, arr) => {
              // Preserve the blue highlight on "Clients" from the original text
              if (word.toLowerCase() === 'clients') {
                return <span key={i} style={{ color: '#3B7BCE' }}>{word}{i < arr.length - 1 ? ' ' : ''}</span>;
              }
          ...
          <p style={{
            ...
            {contentText.section_description}
          </p>
        </div>
                    ...
                    <div style={{
                      ...
                      <a 
                        ...
                        onClick={(e) => {
                          e.preventDefault();
                          e.stopPropagation();
                          handleNavigation(services[0].key); // Use correct index for each button
                        }}
                        onMouseEnter={(e) => {
                          if (!isMobile && !isTablet) {
                    ...
                    <div style={{
                      ...
                      <a 
                        ...
                        onClick={(e) => {
                          e.preventDefault();
                          e.stopPropagation();
                          handleNavigation(services[1].key); 
                        }}
                        onMouseEnter={(e) => {
                          if (!isMobile && !isTablet) {
                    ...
                    <div style={{
                      ...
                      <a 
                        ...
                        onClick={(e) => {
                          e.preventDefault();
                          e.stopPropagation();
                          handleNavigation(services[2].key); 
                        }}
                        onMouseEnter={(e) => {
                          if (!isMobile && !isTablet) {
                    ...
                    <div style={{
                      ...
                      <a 
                        ...
                        onClick={(e) => {
                          e.preventDefault();
                          e.stopPropagation();
                          handleNavigation(services[3].key); 
                        }}
                        onMouseEnter={(e) => {
                          if (!isMobile && !isTablet) {
