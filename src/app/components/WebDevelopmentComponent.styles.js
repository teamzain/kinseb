...
export const HorizontalShimmerEffect = styled.div`
  position: absolute;
  top: 0;
  left: -100%;
  width: 100%;
...
export const Heading = styled.h3`
  font-size: ${props => props.isMobile ? '25px' : props.isTablet ? '20px' : '22px'};
  font-weight: 600;
  margin: 0 0 10px;
  margin-top: ${props => props.marginTop || '0'};
  color: white;
...
export const Paragraph = styled.p`
  font-size: ${props => props.isMobile ? '14px' : props.isTablet ? '13px' : '14px'};
  line-height: 1.5;
  margin: 0 auto;
  padding: 0;
  margin-top: ${props => props.marginTop || '0'};
  margin-left: ${props => props.marginLeft || '0'};
  max-width: ${props => props.isMobile ? '120%' : props.isTablet ? '95%' : '90%'};
  color: white;
  opacity: 0.9;
  white-space: normal;
`;
...
export const ButtonContainer = styled.div`
  position: absolute;
  bottom: ${props => props.isMobile ? '30px' : props.isTablet ? '20px' : '40px'};
  left: 0;
  width: 100%;
  display: flex;
  justify-content: center;
...
export const Button = styled.button`
  background-color: ${props => 
    !props.isMobile && !props.isTablet && props.isActive ? props.color : 'transparent'
  };
  background: ${props => 
    (props.isMobile || props.isTablet) && props.isActive ? 
    `linear-gradient(90deg, ${props.color}, rgba(255,255,255,0.2))` : 'transparent'
  };
  border: 2px solid ${props => props.color};
  border-radius: 4px;
  color: ${props => 
    !props.isMobile && !props.isTablet && props.isActive ? '#0b0f21' : 'white'
  };
  padding: ${props => props.isTablet ? '6px 14px' : '8px 16px'};
  cursor: pointer;
  font-size: ${props => props.isTablet ? '13px' : '14px'};
  font-weight: 600;
  ...
  &:hover {
    background: ${props => 
      ...
      `linear-gradient(90deg, ${props.color}, rgba(255,255,255,0.2))` : 'inherit'
    };
  }
`;
