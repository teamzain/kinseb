...
const BusinessNeedsSection: React.FC<BusinessNeedsSectionProps> = ({ 
  ...
  const urlServiceId = params?.id ? String(params.id) : null;
  
const currentServiceId = urlServiceId || serviceId || "1";
const currentService = useMemo(() => {
  return servicesData.services.find((service: any) => 
    service.id === currentServiceId || 
    service.id === String(currentServiceId) ||
    Number(service.id) === Number(currentServiceId)
