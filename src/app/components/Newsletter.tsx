        ...
        <style jsx>{`
          ...
          @media (max-width: 768px) {
            ...
            .input-group {
              ...
              /* Add horizontal margin for side spacing */
              margin-left: 1rem;
              margin-right: 1rem;
            ...
            .submit-button {
              min-width: 110px; /* Slightly smaller button */
              width: auto;
              justify-content: center;
              white-space: nowrap;
          ...
          /* Very small screens - keep row layout with more spacing */
          @media (max-width: 480px) {
            ...
            .input-group {
              ...
              flex-direction: row;
              margin-top: -300px;
              gap: 0.4rem; /* Smaller gap for tighter fit */
              /* Increase side margins for more breathing room */
              margin-left: 1.5rem;
              margin-right: 1.5rem;
              max-width: calc(100% - 3rem);
              /* Make the overall input group smaller */
              padding: 0.6rem;
            }

            .email-input {
              min-width: 0; /* Ensure input shrinks properly */
              font-size: 0.85rem; /* Smaller font for very small screens */
              padding: 0.65rem 0.9rem; /* Smaller padding */
            }
