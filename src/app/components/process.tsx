...
const WebDesignProcess = () => {
  ...
  const processSteps = [
    {
      ...
      alt: 'Strategic Discovery process illustration showing business analysis and planning'
    },
     {
      number: '02',
    ...
    },
    {
      ...
      alt: 'Performance Optimization illustration showing website speed optimization and SEO'
    },
  ];
  ...
  const getResponsiveStyles = () => {
    ...
    // Override for desktop - FIXED IMAGE POSITIONING
    if (deviceType === 'desktop') {
      return {
        ...
        image: {
          ...
          width: '220px',
          maxWidth: '220px',
          marginTop: '40px' // ADJUSTED: Changed from '-50px' to '-20px' to display a little bit down
        },
        numberContainer: {
          ...styles.numberContainer,
          paddingTop: '140px',
        ...
        description: {
          ...
          fontSize: '1rem',
          lineHeight: '1.5',
          marginTop: '20px' // Maintained margin-top for description
        },
        bulletPoint: {
          ...styles.bulletPoint,
          fontSize: '1rem',
                ...
                {getVisibleSteps().map(({ step, index }, position) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <ul 
                        className={`bullet-list ${deviceType === 'mobile' ? 'mobile-bullets' : ''}`}
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "Professional web design process from research to results, including strategic discovery, creative design, strategy & structure, responsive development, quality assurance, and performance optimization.",
              "provider": {
                "@type": "Organization",
              ...
              "mainEntityOfPage": {
                "@type": "WebPage",
                "name": "Web Design Process",
                "description": "Learn about our comprehensive 6-step web design process that transforms ideas into impactful websites."
              },
             "keywords": [
  "web design process",
  "website development",
  ...
  "branding and identity"
        ...
        <style>
          {`
            ...
            .bullet-list li {
              margin-left: -10px;
              padding-left: -3; /* Removed padding to tighten space between dot and text */
  ...
  text-align: left;
  margin-top: 10px;
  margin-left: 0; /* Moved all the way left */
  margin-bottom: 15px;
}

.mobile-bullets li {
  padding-left: 0;
  margin-left: 15px; /* Added specific indentation for the bullet */
  margin-bottom: 8px;
}
