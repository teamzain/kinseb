      ...
      >
        <div style={{
          ...
          <div style={{
            ...
            margin: screenSize.isMobile ? '0 auto 1rem' : 'auto',
            overflow: 'visible',
            ...
            <div style={{
              ...
              alignItems: 'center',
              overflow: 'visible',
              padding: screenSize.isMobile ? '0.5rem' : 0,
            }}>
              <Image
                ...
                width={600}
                height={500}
                priority // Simplified priority attribute
                quality={90}
              />
            </div>
          </div>
        ...
        {/* Enhanced image optimization with modern approach */}
