    ...
    >
      ...
      <style jsx>{`
        .faq-container {
          ...
          padding: clamp(2rem, 8vw, 4.8rem) 0;
          display: flex;
        ...
        .faq-title {
          ...
          color: #FFFFFF;
          text-align: center;
          margin: 0 0 clamp(2rem, 6vw, 4.2rem) 0;
          opacity: 0;
        ...
        .faq-item.closed {
          min-height: clamp(4rem, 12vw, 6.6rem);
        }

        .faq-item.open {
          min-height: clamp(8rem, 20vw, 11.7rem);
          height: auto;
        ...
        .faq-content-wrapper {
          ...
          width: 100%;
          height: 100%;
          padding-left: clamp(4rem, 12vw, 8.9rem);
        ...
        .faq-answer {
          ...
          color: #E6E6E6;
          margin: 0;
          padding-right: clamp(2rem, 6vw, 3.75rem);
