...
const HeroSection = () => {
  ...
  return (
    <div className="relative w-full h-[60vh] overflow-hidden bg-black">
      ...
      {/* Background Video - 80vh height */}
      <video 
        ref={videoRef}
        className={`absolute top-0 left-0 w-full h-[80vh] object-cover z-0 transition-opacity duration-1000 ${videoLoaded ? 'opacity-60' : 'opacity-0'}`}
        autoPlay
        loop
        muted
        playsInline
      ...
      {/* Bottom text */}
      <div className="absolute bottom-8 left-0 w-full text-center text-white text-sm">
