        ...
        <style jsx>{`
          ...
          @media (max-width: 768px) {
            ...
            .content-container {
              ...
              align-items: center;
              text-align: center;
              gap: 1.5rem; /* Reduced gap between elements on mobile */
              padding: 1.5rem;
            }
            ...
            .text-content {
              ...
              flex-direction: column;
              align-items: center;
              margin-bottom: 0.5rem; /* Reduce space between text and form */
            }
            
            .sub-heading {
              margin-left: auto;
              margin-right: auto;
              margin-bottom: 0.5rem; /* Reduce space after subheading */
            }
          ...
          @media (max-width: 480px) {
            .newsletter-section {
              padding: 2rem 0; /* Further reduced section height */
            }
