  ...
  return (
    <section ref={sectionRef} style={styles.frame}>
      ...
      <div style={{
        ...
        <h3 style={{...styles.subheading, fontFamily: poppins.className}}>Turn Your Ideas Into</h3>
        <h2 style={{...styles.heading, fontFamily: poppins.className}}>
...
const styles: Record<string, CSSProperties> = {
  ...
  leftContent: {
    ...
    transition: 'all 0s',
    marginTop: '-40px', // Moving heading up as requested
  },
  subheading: {
    fontWeight: 600,
    fontSize: '25px',
