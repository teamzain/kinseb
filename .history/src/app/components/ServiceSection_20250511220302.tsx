...
const DesignExperienceSection: React.FC<DesignExperienceSectionProps> = ({ 
  ...
  // Design word stack configuration
  const designWords = [
    { color: '#0D98BA', top: '0px', opacity: 1, transform: 'translateY(0)' },
    { color: '#0D98BA', top: '30px', opacity: 0.8, transform: 'translateY(0)' },
    { color: 'white', top: '60px', opacity: 0.6, transform: 'translateY(0)' },
    { color: 'white', top: '90px', opacity: 0.4, transform: 'translateY(0)' },
    { color: 'white', top: '120px', opacity: 0.2, transform: 'translateY(0)' },
    { color: '#0D98BA', top: '150px', opacity: 0.1, transform: 'translateY(0)' },
  ];
...
const styles = {
  ...
  designWord: {
    ...
    color: 'transparent',
    textShadow: '0 2px 10px rgba(13, 152, 186, 0.2)',
    opacity: 0,
