  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-[#091135] z-50" role="navigation" aria-label="Main Navigation">
      <div className="flex justify-between items-center py-4 px-4 md:px-8 lg:px-12 max-w-[1400px] mx-auto">
        ...
        {/* Button Container - Pushed further to the right */}
        <div className="flex items-center ml-auto">
          ...
          {/* Hamburger Button - Pushed to the right */}
          <div 
      ...
      >
        ...
        <div className="h-full flex flex-col">
          ...
          {/* Mobile Quote Button - Added for mobile view inside menu */}
          <Link 
            href="/quote" 
            className="md:hidden bg-[#0D98BA] text-white py-2 px-4 rounded-md text-sm font-semibold shadow-md text-center hover:bg-[#0B8DAD] transition-colors duration-300"
            aria-label="Request A Quote"
            onClick={() => setIsMenuOpen(false)}
          >
            Request A Quote
