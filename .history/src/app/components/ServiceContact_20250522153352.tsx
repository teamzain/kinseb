      ...
      const floatAnimation = () => {
        ...
        if (mockup1 && mockup2) {
          ...
          const animate = (timestamp: number) => {
            ...
            const rotate1 = Math.sin(elapsed / 4000) * 2;
            const rotate2 = Math.sin(elapsed / 4500 + Math.PI/2) * 3;
            
            mockup1.style.transform = `translateY(${translateY1}px) rotate(${2 + rotate1}deg)`;
            mockup2.style.transform = `translateY(${translateY2}px) rotate(${-1 + rotate2}deg)`;
            ...
            <div className="content-layout">
              ...
              <div className="mockups-container">
                ...
                >
                  <div className="mockup-card-inner">
                    <div className="mockup-image">
                      <img src="/api/placeholder/280/360" alt="Website Design Example 1" />
                    </div>
                ...
                >
                  <div className="mockup-card-inner">
                    <div className="mockup-image">
                      <img src="/api/placeholder/260/320" alt="Website Design Example 2" />
                    </div>
                    <div className="mockup-glow"></div>
                  </div>
                </div>
