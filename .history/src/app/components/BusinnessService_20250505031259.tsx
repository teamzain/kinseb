...
export default function BusinessServices() {
  ...
  // For the grid, we need to handle responsive layout in a different way
  // since CSS media queries don't work directly in inline styles
  return (
    <div style={containerStyle}>
      <div style={contentStyle}>
        ...
        {/* For responsive grid, we'll use className with Tailwind or you can add a separate CSS file */}
