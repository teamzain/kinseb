      ...
      <style>{`
        * {
        ...
        .service-slider {
          ...
          left: 400px; /* Start from behind the sidebar */
          ...
          z-index: 500; /* Below navbar but above other content */
        ...
        .service-slider.open {
          ...
          z-index: 500; /* Keep below navbar when open */
        }
        ...
        @media (min-width: 769px) {
          ...
          .service-slider {
            ...
            pointer-events: none;
            transition: all 0.8s cubic-bezier(0.16, 1, 0.3, 1);
            top: 80px; /* Ensure it starts below navbar */
          ...
          .menu-open .service-slider.open {
            transform: translateX(0);
            z-index: 500; /* Below navbar, above content */
          }
