...
const StatItem = ({ icon, title, subtitle, highlighted = false, delay, isVisible, counter, isSmallMobile, isMobile, isTablet }) => {
  const statItemStyle = useMemo(() => ({
    ...
    position: 'relative',
    overflow: 'hidden',
    marginBottom: isSmallMobile || isMobile ? '20px' : 0,
  ...
  return (
    ...
    >
      <div className="stat-icon"
        style={{
          width: isSmallMobile ? '70px' : isMobile ? '80px' : isTablet ? '90px' : '100px',
      ...
      <h3 
        style={{
          ...
          fontSize: isSmallMobile ? '28px' : isMobile ? '32px' : isTablet ? '38px' : highlighted ? '50px' : '45px',
...
const Banner = () => {
  ...
  const bannerStyles = useMemo(() => ({
    position: 'relative',
    width: '100%',
    height: isSmallMobile ? 'auto' : isMobile ? 'auto' : isTablet ? '700px' : '730px',
    minHeight: isSmallMobile ? '820px' : isMobile ? '800px' : '700px',
  ...
  const statsContainerStyles = useMemo(() => ({
    ...
    alignItems: 'center',
    width: '100%',
    maxWidth: isSmallMobile ? '100%' : isMobile ? '90%' : '1200px',
    marginTop: isSmallMobile ? '40px' : isMobile ? '50px' : isTablet ? '80px' : '120px',
    gap: isSmallMobile ? '10px' : isMobile ? '20px' : '25px',
  ...
  const ctaContainerStyles = useMemo(() => ({
    ...
    display: 'flex',
    justifyContent: 'center',
    marginTop: isSmallMobile ? '40px' : isMobile ? '60px' : isTablet ? '80px' : '120px',
    position: 'relative',
    zIndex: 2,
  }), [isSmallMobile, isMobile, isTablet]);
