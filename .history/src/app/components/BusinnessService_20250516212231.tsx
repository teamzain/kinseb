...
export default function BusinessServices() {
  ...
  const autoScrollTimerRef = useRef<NodeJS.Timeout | null>(null); // Reference to track the auto-scroll timer
  ...
  }, [isVisible, isMobile, autoScrollActive, cardSetIndex, maxScrollIndex, services.length]);
