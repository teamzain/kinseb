...
const Banner = () => {
  ...
  const headerStyles = useMemo(() => ({
    ...
    alignItems: 'center',
    width: '100%',
    marginTop: isSmallMobile ? '20px' : isMobile ? '30px' : isTablet ? '25px' : '35px', // Reduced margin-top for header
  }), [isSmallMobile, isMobile, isTablet]);
  ...
  const subtitleStyles = useMemo(() => ({
    ...
    marginTop: isSmallMobile ? '25px' : isMobile ? '28px' : isTablet ? '20px' : '22px', // Reduced margin-top for subtitle
    textAlign: 'center',
    color: COLORS.primary,
    margin: `${isSmallMobile ? '25px' : isMobile ? '28px' : isTablet ? '20px' : '22px'} auto 0px auto`, // Updated margin with reduced top value
  ...
  const headingStyles = useMemo(() => ({
    ...
    lineHeight: isSmallMobile ? '56px' : isMobile ? '60px' : isTablet ? '60px' : '80px', // Smaller line height
    textAlign: 'center',
    color: COLORS.white,
    margin: isSmallMobile ? '12px 0 0' : isMobile ? '15px 0 0' : isTablet ? '18px 0 0' : '20px 0 0', // Reduced margin-top for title
          ...
          <header style={headerStyles} itemScope itemProp="headline">
            ...
            <div
              style={{
                ...
                background: `linear-gradient(90deg, transparent 0%, ${COLORS.primary} 50%, transparent 100%)`,
                borderRadius: '2px',
                marginTop: '12px', // Reduced margin for decorative divider
                opacity: isVisible ? 1 : 0,
  ...
  <Link href="/contact" passHref style={{ display: 'contents'}}>
