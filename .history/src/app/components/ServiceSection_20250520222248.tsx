...
const DesignServices: React.FC = () => {
  ...
  const ServiceCard: React.FC<ServiceCardProps> = ({ title, description, featured = false, index }) => {
  ...
  return (
    <>
      <Head>
        <title>Design Services | Your Company</title>
        <meta name="description" content="Professional design services including website design, mobile apps, branding, and more. Transform your digital presence with our expert design solutions." />
