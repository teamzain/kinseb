    ...
    <>
      ...
      <style jsx global>{`
        * {
        ...
        /* Menu panel - FIXED: Proper 400px width and transform */
        .menu-side {
          position: fixed;
          top: 0;
          right: -400px; /* Changed from -30px to -400px */
          width: 400px; /* Exactly 400px as requested */
          height: 100vh;
        ...
        .menu-side.open {
          transform: translateX(-400px); /* Changed from -340px to -400px */
        }
      ...
      <nav className="navbar" role="navigation" aria-label="Main Navigation">
        ...
        >
          ...
          {/* Newsletter signup - Updated to match the second image */}
