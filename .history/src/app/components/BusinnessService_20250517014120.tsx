  ...
  const fetchSectionData = async () => {
    try {
      ...
      if (error) {
        ...
        console.log('Fetched business section data:', data); // Add logging to verify data
        setSectionData(data);
      } else {
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <div style={{ 
              ...
              height: '50px', 
              borderRadius: '50%', 
              border: '5px solid rgba(54, 178, 200, 0.3)',
              borderTop: '5px solid #36b2c8',
              margin: '20px auto',
    ...
    <div style={containerStyle} ref={sectionRef}>
      <div style={contentStyle}>
        ...
        <div style={{
          ...
          <p>
            {/* Show error message without exposing sensitive details */}
            {error.includes('Database') ? 
              'Unable to load content. Using default information instead.' : 
              error
            }
          </p>
        </div>
