  ...
  return (
    <>
      ...
      <div style={{
        ...
        overflow: 'hidden',
        height: '100vh', // Changed to 100vh to ensure full height on mobile
        width: '100%',
        maxWidth: '100%',
        ...
        <div style={{
          ...
          <div className="content-container" style={{
            ...
            <h1 className="heading-animation" style={{ fontSize: '56px', marginBottom: '25px', fontWeight: '700', lineHeight: 1.1, textAlign: 'center' }}>
              <div style={{ display: 'block' }}>Building <span style={{ color: '#0099cc' }}>Websites</span> That</div>
              <div style={{ display: 'block' }}>Drive Growth</div>
            </h1>
            <p className="fade-in" style={{ fontSize: '20px', lineHeight: 1.6, marginBottom: '35px', maxWidth: '700px', textAlign: 'center' }}>
            ...
            <div className="buttons-animation" style={{ display: 'flex', gap: '15px', justifyContent: 'center' }}>
              <button style={{
        ...
        <style jsx global>{`
          ...
          @media (max-width: 768px) {
            .content-container {
              ...
              padding-top: 180px !important; /* Move content further down */
          ...
          @media (max-width: 640px) {
            .content-container {
              ...
              padding-top: 100px !important; /* Adjusted for smaller screens */
            }
            
            .content-container h1 {
              font-size: 36px !important;
              margin-bottom: 20px !important;
              line-height: 1.2 !important; /* Improve line spacing */
            }
          ...
          @media (max-width: 480px) {
            .content-container {
              ...
              padding-top: 90px !important; /* Position content higher as shown in screenshot */
