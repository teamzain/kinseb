      ...
      <style>{`
        * {
        ...
        .service-slider {
          position: fixed;
          top: 0;
          left: 400px; /* Always start after menu width */
          right: 0;
          height: 100vh;
        ...
        /* Desktop: Service slider covers remaining screen when menu is open */
        @media (min-width: 769px) {
          /* Service slider is always positioned after menu */
          .service-slider {
            left: 400px;
            width: calc(100vw - 400px);
          }

          /* When menu is closed, service slider covers full screen */
          .service-slider:not(.menu-open) {
            left: 0;
            width: 100vw;
          }
        }
