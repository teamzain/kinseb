            ...
            {services.map((service, index) => (
              <div 
                ...
                style={{
                  ...
                  marginBottom: '20px',
                  backgroundColor: `rgba(${parseInt(service.color.slice(1, 3), 16)}, ${parseInt(service.color.slice(3, 5), 16)}, ${parseInt(service.color.slice(5, 7), 16)}, 0.05)`,
                  borderRadius: '8px',
                }}
              >
                {/* Vertical indicator */}
