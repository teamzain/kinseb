...
const ContactSection = () => {
  ...
  return (
    <section ref={sectionRef} style={styles.frame}>
      ...
      {/* Left Side */}
      <div style={isVisible ? {...styles.leftContent, ...styles.fadeInLeft} : styles.leftContent}>
        ...
        <div style={styles.social}>
          ...
          <div style={styles.socialIcons}>
            <a href="#" style={styles.iconLink}>
              <i style={styles.icon} className="twitter-icon">
            ...
            <a href="#" style={styles.iconLink}>
              <i style={styles.icon} className="facebook-icon">
            ...
            <a href="#" style={styles.iconLink}>
              <i style={styles.icon} className="instagram-icon">
                <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="#" style={styles.iconLink}>
              <i style={styles.icon} className="linkedin-icon">
                <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div style={isVisible ? {...styles.formContainer, ...styles.fadeInRight} : styles.formContainer}>
