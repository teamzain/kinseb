    ...
    >
      ...
      <h3 
        style={{
          ...
          lineHeight: isSmallMobile ? '28px' : isMobile ? '32px' : isTablet ? '38px' : '108px', // Smaller line height
          textAlign: 'center',
          letterSpacing: '0.03em',
          color: COLORS.white,
          margin: '0 0 px 0', // Reduced margin
...
const Banner = () => {
  ...
  const subtitleStyles = useMemo(() => ({
    ...
    marginTop: isSmallMobile ? '34px' : isMobile ? '26px' : isTablet ? '23px' : '24px', // Smaller line height
    textAlign: 'center',
    color: COLORS.primary,
    margin: '0px auto',
  ...
  const headingStyles = useMemo(() => ({
    ...
    textAlign: 'center',
    color: COLORS.white,
    margin: isSmallMobile ? '1px 0 0' : isMobile ? '0px 0 0' : isTablet ? '20px 0 0' : '-30px 0 0',
