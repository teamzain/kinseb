...
const defaultCards = [
  ...
  },
  {
    ...
    description: "Native and cross-platform mobile application development for iOS and Android. We create apps that deliver exceptional user experiences and drive engagement.",
