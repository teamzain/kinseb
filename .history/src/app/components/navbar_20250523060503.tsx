    ...
    <>
      ...
      <style>{`
        * {
        ...
        /* ========== OPTIMIZED SERVICE SLIDER STYLES ========== */
        .service-slider {
          position: fixed;
          top: 0;
          right: 100%; /* Start completely off-screen to the left */
          width: 500px; /* Increased width for desktop */
          height: 100vh;
          background: linear-gradient(135deg, #050922 0%, #0a1240 100%);
          z-index: 1001; /* Behind the sidebar menu */
          transition: all 0.8s cubic-bezier(0.23, 1, 0.32, 1); /* Slower, smoother animation */
          overflow: hidden;
          display: flex;
          box-shadow: 5px 0 32px rgba(0, 0, 0, 0.25);
          backdrop-filter: blur(10px);
          border-radius: 15px 0 0 15px; /* Rounded left edge */
        }

        /* When service slider opens, it slides from behind the menu */
        .service-slider.open {
          right: 400px; /* Position it right next to the sidebar menu */
        }

        /* Left tabs section - OPTIMIZED */
        .service-slider-tabs {
          width: 200px; /* Adjusted for new width */
        ...
        /* Right content section - OPTIMIZED */
        ...
        .service-slider-title {
          color: #ffffff;
          font-size: 1.8rem; /* Adjusted for new layout */
          font-weight: 700;
          margin: 0;
        ...
        /* Service items grid - OPTIMIZED FOR NEW WIDTH */
        ...
        .service-slider-link {
          ...
          text-decoration: none;
          font-size: 1.1rem; /* Slightly smaller for new layout */
          font-weight: 600;
        ...
        .overlay {
          ...
          z-index: 1000; /* Below both sidebar and slider */
          opacity: 0;
          visibility: hidden;
        ...
        .service-slider-open .service-slider {
          z-index: 1001; /* Always behind sidebar */
        }
        ...
        /* Large screens - optimized for new slider width */
        @media (min-width: 1200px) {
          .service-slider {
            width: 550px; /* Even wider on large screens */
          }
        ...
        @media (max-width: 768px) {
          ...
          /* SERVICE SLIDER MOBILE OPTIMIZATIONS */
          .service-slider {
            flex-direction: column;
            transition: all 0.8s cubic-bezier(0.23, 1, 0.32, 1);
            z-index: 1003; /* Higher on mobile to cover everything */
          ...
          .service-slider.open {
            right: 0; /* Slide to cover full screen on mobile */
          }
        ...
        @media (max-width: 480px) {
          ...
          .service-slider {
            right: 0; /* Full screen on very small devices */
          }
