...
const WebDesignSection = () => {
  ...
  // Improved media query hook for better responsiveness
    ...
    <>
      ...
      >
        <div style={{
          ...
          {/* Right side - Image Container with improved responsive handling */}
          <div style={{
            flex: '1 1 500px',
            position: 'relative',
            width: isMobile ? '100%' : '50%',
            height: isMobile ? '300px' : '422px', // Fixed height to maintain aspect ratio
            margin: '0 auto',
            overflow: 'hidden',
        ...
        {/* Hidden WebP version for moderm browsers - SEO best practice */}
        <link rel="preload" as="image" href="/images/about-3.webp" type="image/webp" />
      </section>
    </>
  );
};
