  ...
  return (
    <>
      ...
      <div style={{
        position: 'relative',
        width: '100%',
        minHeight: isMobile ? '950px' : '800px', // Increased height for mobile to accommodate gap
            ...
            >
              ...
              <motion.div
                ...
                style={{
                  flex: isMobile ? 'unset' : '1',
                  width: '100%',
                  height: isMobile ? '240px' : '400px', // Taller image on mobile for better visibility
                  position: 'relative',
