export default WebDevelopmentComponent;'use client';
  ...
  return (
    <>
      <Head>
        ...
        <meta name="twitter:image" content="https://yourwebsite.com/images/web-development-twitter.jpg" />
