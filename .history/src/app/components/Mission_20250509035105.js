...
const styles = {
  frame: {
    ...
    padding: '80px 0', // Increased padding for top and bottom
    display: 'flex',
  ...
  mainHeading: {
    ...
    textAlign: 'center',
    color: '#FFFFFF',
    margin: '40px 0 60px 0', // Added more space above and below
    width: '100%',
  },
  accentText: {
    color: '#0D98BA',
  ...
  carousel: {
    position: 'relative',
    width: '100%',
    height: '580px', // Increased to match container height
  },
  container: {
    boxSizing: 'border-box',
    position: 'relative',
    width: '100%',
    height: '580px', // Increased height to allow more space for content
  ...
  textContainer: {
    position: 'relative',
    width: '535px',
    margin: '180px 0 0 75px', // Increased top margin to move content further down
    zIndex: 2,
  },
  h2: {
    position: 'absolute',
