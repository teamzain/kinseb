...
export default function WebSolutions(): ReactElement {
  ...
  const serviceImages: Array<{src: string, alt: string}> = [
    { src: '/images/service.png', alt: 'Default service visualization' },
    { src: '/images/conversion.png', alt: 'Performance optimization service visualization' },
    { src: '/images/performance.png', alt: 'Industry-specific solutions visualization' },
    { src: '/images/industry.png', alt: 'Reliable support service visualization' },
    { src: '/images/reliable.png', alt: 'Responsive design service visualization' },
    { src: '/images/service.png', alt: 'Data-driven design visualization' },
    { src: '/images/Driven.png', alt: 'SEO optimization service visualization' },
    { src: '/images/seoservice.png', alt: 'Collaboration process visualization' },
    { src: '/images/web-dev.png', alt: 'Web development services visualization' },
  ];
