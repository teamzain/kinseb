    ...
    <>
      <style jsx global>{`
        ...
        .newsletter-form {
          ...
          flex-direction: column;
          gap: 0.75rem;
          width: 100%; /* Make form take full width of column */
        ...
        .newsletter-input {
          ...
          transition: all 0.3s ease;
          width: 250px;
          padding-right: 90px; /* Reduced from 130px to give more space to the input */
        ...
        .newsletter-button {
          ...
          top: 50%;
          transform: translateY(-50%);
          padding: 0.7rem 1.4rem; /* Reduced horizontal padding from 1.8rem to 1.4rem */
          height: 38px; /* Slightly increased height */
          display: flex;
          align-items: center;
          justify-content: center;
          width: 75px; /* Added explicit width to make button narrower */
        }
        ...
        @media (max-width: 1100px) {
          ...
          .newsletter-form {
            max-width: 600px; /* Increased max-width for tablet view */
      ...
      <footer className="footer" role="contentinfo" itemScope itemType="http://schema.org/WPFooter">
        <div className="footer-container">
          <div className="footer-content">
            ...
            {/* Empty columns to maintain layout spacing */}
