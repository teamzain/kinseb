          ...
          * {
          ...
          @media (max-width: 1100px) {
            .services-container {
              ...
              gap: 20px !important; /* Reduce gap between elements on mobile */
            }
            
            .services-info {
              position: static !important;
              top: auto !important;
              margin-bottom: 30px !important; /* Reduce bottom margin */
              min-width: 100%;
              padding-right: 0;
            ...
            .services-heading {
              margin-bottom: 20px !important; /* Reduce space after heading */
            }
            
            .laptop-container {
              margin-bottom: 10px !important; /* Reduce space after laptop */
            }
            ...
            .service-card {
              ...
              margin-bottom: 20px !important; /* Reduce margins between cards */
            }
          ...
          @media (max-width: 768px) {
            ...
            .services-section {
              padding: 60px 4% !important; /* Reduce padding at top and bottom */
            }
          ...
          @media (max-width: 480px) {
            .services-section {
              padding: 40px 20px !important; /* Further reduce padding on very small screens */
            }
            
            .service-card {
              padding: 25px 20px;
              margin-bottom: 15px !important; /* Even smaller margin on tiny screens */
            }
          }
