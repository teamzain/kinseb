...
export default function LandingPage() {
  ...
  return (
    <main className="landing-container">
      ...
      {/* Right side - Contact Form - Updated to match first code */}
      <div 
      ...
      <style jsx>{`
        ...
        /* Left Content Styles - Kept from second code */
        .left-content {
          flex: 1;
          max-width: 50%;
          height: 100%;
        ...
        /* Background image container - Kept from second code */
        .background-image {
          width: 90%;
          height: 200px;
          max-height: 250px;
        ...
        /* Contact Info Styles - Kept from second code */
        .contact-info {
          margin-top: auto;
          padding-top: 2rem;
        ...
        /* Social Icons Row - Kept from second code */
        .social-icons {
          display: flex;
          gap: 1.25rem;
        }
        ...
        /* Form Container Styles - Updated to match first code */
        .form-container {
          flex: 1;
          max-width: 50%;
        ...
        /* Form Styles - Updated to match first code */
        .contact-form {
          width: 100%;
        }
        ...
        /* Responsive Styles - Combined from both codes */
