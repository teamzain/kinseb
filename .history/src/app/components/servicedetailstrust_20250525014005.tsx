...
const TrustSection: React.FC<TrustSectionProps> = ({ 
  ...
  // Responsive breakpoint helpers - IMPROVED ANDROID DETECTION
  const isMobile = windowWidth < BREAKPOINTS.tablet; // Using 768 as breakpoint
  ...
  // Memoized style calculations - FIXED ANDROID MOBILE RESPONSIVENESS
  const containerStyles = useMemo(() => ({
    minHeight: isMobile ? '1100px' : '800px', // Consistent with reference code
    background: 'linear-gradient(180deg, #04091D 39.13%, #0D98BA 263.77%)',
  }), [isMobile]);

  const headingStyles = useMemo(() => ({
    fontSize: isMobile ? '28px' : '48px', // Simplified breakpoints for Android
    lineHeight: isMobile ? '38px' : '56px', // Simplified breakpoints for Android
  }), [isMobile]);

  const subheadingStyles = useMemo(() => ({
    fontSize: isMobile ? '25px' : '48px', // Simplified breakpoints for Android
    lineHeight: isMobile ? '36px' : '56px', // Simplified breakpoints for Android
  }), [isMobile]);
      ...
      <div style={{
        ...
        <motion.div 
          ...
          style={{
            ...
            width: '100%',
            textAlign: 'center',
            top: isMobile ? '30px' : '40px', // Fixed mobile spacing
            padding: '0 12px', // Fixed mobile padding
            marginBottom: '0',
            boxSizing: 'border-box',
            zIndex: 5,
            maxWidth: '100%'
        ...
        >
          ...
          <h2 className={poppins.className} style={{
            ...
            marginBottom: '16px',
            display: 'block',
            whiteSpace: isMobile ? 'normal' : 'nowrap', // Fixed mobile wrapping
            padding: '0 10px',
          }}>
        ...
        {/* Navigation Tabs with Sliding Indicator - FIXED ANDROID POSITIONING */}
        <div style={{
          position: 'absolute',
          width: '100%',
          maxWidth: isMobile ? '95%' : '1100px',
          left: '50%',
          top: isMobile ? '165px' : '220px', // Simplified positioning for Android
                ...
                {tabs.map((tab, index) => (
                  ...
                  >
                    <h3 className={poppins.className} style={{
                      fontWeight: '500',
                      fontSize: '16px', // Fixed mobile font size
                      lineHeight: '22px', // Fixed mobile line height
                      textAlign: 'center',
                      letterSpacing: '-0.03em',
                    ...
                    {tab.id === activeTab && (
                      <svg 
                        ...
                        style={{
                          position: 'absolute',
                          bottom: '60px', // Fixed arrow position
                          left: '50%',
                          transform: 'translateX(-50%)',
                          zIndex: 2
                        }}
        ...
        {/* Blue Line - FIXED ANDROID POSITIONING */}
        <div style={{
          position: 'absolute',
          width: isMobile ? '95%' : '1100px',
          height: '4px',
          left: '50%',
          top: isMobile ? '238px' : '290px', // Simplified positioning for Android
          transform: 'translateX(-50%)',
          background: '#0D98BA',
          borderRadius: '10px',
          zIndex: 1
        ...
        {/* Content Container - FIXED ANDROID SPACING */}
        <div style={{
          position: 'absolute',
          width: '100%',
          maxWidth: isMobile ? '95%' : '1100px',
          top: isMobile ? '262px' : '320px', // Simplified positioning for Android
          left: '50%',
          transform: 'translateX(-50%)',
          boxSizing: 'border-box',
          padding: '0 20px'
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              style={{
                ...
                justifyContent: 'space-between',
                alignItems: 'center',
                gap: isMobile ? '36px' : '40px' // Fixed mobile gap
              }}
            >
              {/* Text Content */}
              <motion.div 
              ...
              >
                ...
                <motion.h3 
                  ...
                  style={{
                    fontWeight: '600',
                    fontSize: isMobile ? '22px' : '24px', // Simplified for Android
                    lineHeight: isMobile ? '28px' : '30px', // Simplified for Android
                    color: '#0D98BA',
                    margin: '0 0 18px 0'
                  }}
                >
                ...
                <motion.p 
                  ...
                  style={{
                    fontWeight: '400',
                    fontSize: isMobile ? '16px' : '16px', // Consistent sizing for Android
                    lineHeight: isMobile ? '26px' : '24px', // Better line height for Android
                  ...
                  {tabs[activeTab].features.map((feature, index) => (
                    ...
                    >
                      ...
                      <p className={lato.className} style={{
                        fontWeight: '400',
                        fontSize: isMobile ? '15px' : '16px', // Consistent sizing for Android
                        lineHeight: isMobile ? '22px' : '22px', // Consistent line height for Android
                        letterSpacing: '-0.01em',
                        color: '#FFFFFF',
                        margin: '0'
                      }}>
                ...
                >
                  <motion.button
                    ...
                    style={{
                      ...
                      border: 'none',
                      borderRadius: '12px',
                      padding: isMobile ? '14px 28px' : '16px 32px', // Consistent sizing for Android
                      fontWeight: '600',
                      fontSize: isMobile ? '14px' : '16px', // Consistent sizing for Android
                      color: '#FFFFFF',
                      cursor: 'pointer',
                      display: 'flex',
                      alignItems: 'center',
              ...
              {/* Image Content - Always clickable - FIXED ANDROID DIMENSIONS */}
              <motion.div
                ...
                style={{
                  ...
                  cursor: 'pointer',
                  height: isMobile ? '240px' : '400px', // Consistent with reference code for Android
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
