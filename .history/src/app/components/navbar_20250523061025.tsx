...
const Navbar = () => {
  ...
  /* ========== SERVICE SLIDER STYLES - IMPROVED & RESPONSIVE ========== */
        ...
        .service-slider {
    left: -100px; /* Start behind the menu */
    width: calc(100vw - 390px);
  }

  /* When service slider is open, it slides out to the right from behind menu */
  .service-slider.open {
    left: 400px; /* Slide out to the right of the menu (400px menu width) */
  }
