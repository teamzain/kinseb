...
const defaultCards = [
  {
    ...
    description: "Full-stack web development services including both frontend and backend development. We build robust, scalable web applications tailored to your specific business needs.",
