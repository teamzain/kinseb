      ...
      <div style={{
        ...
        <div style={{
          ...
          {isMobile && (
            <div style={{
              width: '5px',
              height: '120%', // Increased height to create overlap
              position: 'absolute',
        ...
        <div style={{
          ...
          alignItems: 'center',
          textAlign: isMobile ? 'left' : 'center',
          marginTop: isMobile ? '-20px' : '1.25px', // Negative margin to create overlap in mobile
          ...
          {isMobile && (
            <div style={{
              width: '5px',
              height: '120%', // Increased height for overlap
              position: 'absolute',
              left: '15px', // Aligning with the left padding
              top: '0',
        ...
        <div style={{
          ...
          alignItems: 'center',
          textAlign: isMobile ? 'left' : 'center',
          marginTop: isMobile ? '-20px' : '20px', // Negative margin to create overlap in mobile
          marginLeft: isMobile ? '0' : '-20px',
          padding: isMobile ? '15px 15px 25px' : '0', // Added bottom padding for mobile
          opacity: isVisible ? 1 : 0,
          transform: isVisible ? 'translateY(0)' : 'translateY(50px)',
