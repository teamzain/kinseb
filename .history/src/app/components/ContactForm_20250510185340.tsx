  ...
  return (
    <div className="landing-container">
      ...
      <style jsx>{`
        ...
        /* Contact Info Styles */
        .contact-info {
          margin-top: 300px; /* Increased gap before Contact us section */
        }
        ...
        .form-container {
          width: 600px; /* Reduced from 600px to 500px */
        ...
        @media (max-width: 1200px) {
          .form-container {
            width: 450px; /* Reduced from 500px to 450px for this breakpoint */
          }
        }
        ...
        @media (max-width: 1024px) {
          ...
          .form-container {
            width: 400px; /* Reduced from 450px to 400px for this breakpoint */
          }
        ...
        @media (max-width: 900px) {
          ...
          .form-container {
            width: 100%;
            max-width: 600px; /* Reduced from 700px to 600px for this breakpoint */
          }
        }
        ...
        @media (max-width: 768px) {
          ...
          .form-container {
            background: linear-gradient(180deg, #0D98BA -213.84%, #04091D 103.97%);
            max-width: 550px; /* Reduced from 600px to 550px for this breakpoint */
          }
