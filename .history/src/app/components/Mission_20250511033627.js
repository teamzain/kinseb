    ...
    <div style={containerStyle}>
      ...
      <div style={rowContainerStyle}>
        ...
        {isMobile ? (
          ...
          // Tablet Layout with connected horizontal lines and name above, logo below line
          <div style={{ width: '100%', position: 'relative' }}>
            {/* Services in a 2x2 grid for tablet */}
            <div style={{ 
              display: 'flex', 
              flexWrap: 'wrap',
              width: '100%',
              ...
              {services.map((service, index) => (
                <div 
                  ...
                  style={{
                    width: '50%',
                    height: '350px', // Fixed height for consistent alignment
                    padding: '20px',
                    boxSizing: 'border-box',
                    position: 'relative',
                    opacity: isVisible ? 1 : 0,
                ...
                >
                  {/* Description at top for all tablet services */}
                  <p style={{ 
                    fontSize: '14px', 
                    lineHeight: '1.4',
                    margin: '0 0 15px',
                  ...
                  {/* Logos positioned closer to the line */}
                  <div style={{
                    display: 'flex',
                    justifyContent: 'center',
                    alignItems: 'center',
                    marginTop: '15px', // Close to the line
                  }}>
                    <img 
                      src={service.imagePath} 
                      alt={service.name} 
            ...
            {/* Connected horizontal line for top row */}
            <div style={{ 
              position: 'absolute',
              top: '175px', // Position in the middle of the top row
              left: '0',
              width: '100%',
              height: '4px',
              display: 'flex',
            ...
            {/* Connected horizontal line for bottom row */}
            <div style={{ 
              position: 'absolute',
              top: '525px', // Position in the middle of the bottom row
              left: '0',
              width: '100%',
              height: '4px',
              display: 'flex',
