      ...
      <style>{`
        * {
        ...
        .service-slider {
          ...
          margin-right: 420px; /* Add right margin for spacing */
        ...
        .service-slider-tabs {
          width: 320px; /* Increased tab section width */
        ...
        @media (min-width: 769px) {
          /* When menu is closed, service slider should be off-screen */
          .service-slider {
            left: 100%;
            width: calc(100vw - 380px); /* Increased width with smaller margin */
          }

          /* When service slider is open, it appears next to the menu with smaller gap */
          .service-slider.open {
            left: 410px; /* 400px menu + 10px gap */
          }
