    ...
    <>
      ...
      <style jsx global>{`
        * {
        ...
        /* Menu links with icons - UPDATED SPACING */
        .menu-link {
          color: white;
          text-decoration: none;
          font-size: 1.05rem;
      ...
      <nav className="navbar" role="navigation" aria-label="Main Navigation">
        ...
        >
          ...
          <div className="menu-header">
            ...
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M18 6L6 18" stroke="#9ACA3C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M6 6L18 18" stroke="#9ACA3C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </button>
          </div>
          ...
          {/* Divider line after navlinks - UPDATED COLOR */}
          <div className="menu-divider"></div>
            
          {/* Newsletter signup - Updated to match the image */}
