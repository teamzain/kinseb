  ...
  return (
    <>
          ...
          >
            ...
            <div className="content-layout">
              ...
              <div className="mockups-container">
                {/* Website Mockup Card 1 - Background - INCREASED HEIGHT */}
                <div 
                  ref={mockup1Ref}
                ...
                {/* Website Mockup Card 2 - Foreground - DECREASED HEIGHT */}
                <div 
                  ref={mockup2Ref}
      ...
      <style jsx>{`
        ...
        /* Updated main-card with exact specifications */
        .main-card {
          ...
          max-width: 1302px;
          margin: 0 auto;
          background: linear-gradient(270deg, rgba(4, 9, 29, 0) -264.67%, rgba(4, 9, 29, 0.7) 100%), url('/images/card-bg.jpg'), rgba(172, 255, 36, 0.2);
        ...
        /* Content Layout - Frame 26 equivalent */
        .content-layout {
          position: absolute;
          width: 1302px;
          height: 518px;
        ...
        /* Text Content - Left Side with exact positioning */
        .text-content {
          position: absolute;
          width: 942px;
          height: 205px;
        ...
        /* Heading with exact specifications */
        .heading {
          position: absolute;
          width: 1136px;
          height: 128px;
        ...
        /* Paragraph with exact specifications */
        .subtext {
          position: absolute;
          width: 533px;
          height: 81px;
        ...
        /* Buttons Container with exact specifications */
        .button-container {
          display: flex;
          flex-direction: row;
        ...
        /* Button with exact specifications */
        .primary-button {
          width: 157px;
          height: 45px;
          background: #0D98BA;
        ...
        /* Updated mockup positioning - INCREASED HEIGHT for first card, DECREASED HEIGHT for second */
        .mockup-card-1 {
          width: 300px;
          height: 500px; /* INCREASED from 420px to 500px */
          right: 120px;
          top: 10px;
          z-index: 2;
        }
        ...
        .mockup-card-2 {
          width: 280px;
          height: 150px; /* DECREASED from 200px to 150px */
          right: -65px;
          top: 0px;
          z-index: 1;
        }
