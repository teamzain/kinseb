...
const TrustSection: React.FC<TrustSectionProps> = ({ 
  ...
  // Memoized style calculations - FIXED MOBILE RESPONSIVENESS
  const containerStyles = useMemo(() => ({
    minHeight: isMobile ? '1100px' : '800px', // Increased mobile height
    background: 'linear-gradient(180deg, #04091D 39.13%, #0D98BA 263.77%)',
  }), [isMobile]);

  const headingStyles = useMemo(() => ({
    fontSize: isMobile ? '28px' : isTablet ? '40px' : '48px', // Fixed mobile size
    lineHeight: isMobile ? '38px' : isTablet ? '48px' : '56px', // Fixed mobile line height
  }), [isMobile, isTablet]);

  const subheadingStyles = useMemo(() => ({
    fontSize: isMobile ? '25px' : isTablet ? '40px' : '48px', // Fixed mobile size
    lineHeight: isMobile ? '36px' : isTablet ? '48px' : '56px', // Fixed mobile line height
  }), [isMobile, isTablet]);
  ...
  return (
    <>
      ...
      <div style={{
        ...
        {/* Navigation Tabs with Sliding Indicator - FIXED MOBILE POSITIONING */}
        <div style={{
          position: 'absolute',
          width: '100%',
          maxWidth: isMobile ? '95%' : isTablet ? '90%' : '1100px',
          left: '50%',
          top: isMobile ? '165px' : isTablet ? '200px' : '220px', // Fixed mobile positioning
        ...
        {/* Blue Line - FIXED MOBILE POSITIONING */}
        <div style={{
          position: 'absolute',
          width: isMobile ? '95%' : isTablet ? '90%' : '1100px',
          height: '4px',
          left: '50%',
          top: isMobile ? '238px' : isTablet ? '270px' : '290px', // Fixed mobile positioning
          transform: 'translateX(-50%)',
          background: '#0D98BA',
          borderRadius: '10px',
          zIndex: 1
        ...
        {/* Content Container - FIXED MOBILE SPACING */}
        <div style={{
          position: 'absolute',
          width: '100%',
          maxWidth: isMobile ? '95%' : isTablet ? '90%' : '1100px',
          top: isMobile ? '262px' : isTablet ? '300px' : '320px', // Fixed mobile positioning
          left: '50%',
          transform: 'translateX(-50%)',
          boxSizing: 'border-box',
          padding: '0 20px'
            ...
            >
              ...
              >
                ...
                <motion.h3 
                  ...
                  style={{
                    fontWeight: '600',
                    fontSize: isMobile ? '22px' : isTablet ? '23px' : '24px', // Fixed mobile font size
                    lineHeight: isMobile ? '28px' : isTablet ? '29px' : '30px', // Fixed mobile line height
                    color: '#0D98BA',
                    margin: '0 0 18px 0'
                  }}
                >
                ...
                <motion.p 
                  ...
                  style={{
                    fontWeight: '400',
                    fontSize: '16px', // Fixed mobile font size
                    lineHeight: isMobile ? '26px' : '24px', // Fixed mobile line height
                  ...
                  {tabs[activeTab].features.map((feature, index) => (
                    ...
                    >
                      ...
                      <p className={lato.className} style={{
                        fontWeight: '400',
                        fontSize: isMobile ? '15px' : '16px', // Fixed mobile font size
                        lineHeight: isMobile ? '22px' : '22px', // Fixed mobile line height
                        letterSpacing: '-0.01em',
                        color: '#FFFFFF',
                        margin: '0'
                      }}>
                ...
                >
                  <motion.button
                    ...
                    style={{
                      ...
                      border: 'none',
                      borderRadius: '12px',
                      padding: isMobile ? '14px 28px' : '16px 32px', // Fixed mobile padding
                      fontWeight: '600',
                      fontSize: isMobile ? '14px' : '16px', // Fixed mobile font size
                      color: '#FFFFFF',
                      cursor: 'pointer',
                      display: 'flex',
                      alignItems: 'center',
              ...
              {/* Image Content - Always clickable - FIXED MOBILE DIMENSIONS */}
              <motion.div
                ...
                style={{
                  ...
                  cursor: 'pointer',
                  height: isMobile ? '240px' : isTablet ? '380px' : '420px', // Fixed mobile height
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
