...
const WebDevelopmentComponent = () => {
  ...
  return (
    <div style={{
      ...
      textAlign: 'center',
      overflow: 'hidden',
      position: 'relative', // Important for absolute positioning of connector lines
    }}>
      {/* Header Section */}
      <div style={{
        maxWidth: '1200px',
        ...
        <div style={{
          ...
          {isMobile && (
            <div style={{
              ...
              overflow: 'hidden',
              zIndex: 2, // Ensure line is above connectors
            }}>
              <div style={{
                position: 'absolute',
                top: '-100%',
      ...
      {/* Connecting lines for mobile view */}
      {isMobile && (
        <div style={{
          position: 'absolute',
          top: 0,
          ...
          >
            {/* Connect WordPress to Shopify (1st to 2nd) */}
            <path
              d="M 22.5 120 L 22.5 210"
              stroke="#1e90ff"
              strokeWidth="2"
              fill="none"
              strokeDasharray="5,5"
            ...
            {/* Connect Shopify to Magento (2nd to 3rd) */}
            <path
              d="M 22.5 330 L 22.5 420"
              stroke="#95d600"
              strokeWidth="2"
              fill="none"
              strokeDasharray="5,5"
            ...
            {/* Connect Magento to Custom (3rd to 4th) */}
            <path
              d="M 22.5 540 L 22.5 630"
              stroke="#F26322"
              strokeWidth="2"
              fill="none"
              strokeDasharray="5,5"
