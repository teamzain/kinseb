// DesignExperienceSection.js
import React from 'react';

const DesignExperienceSection = () => {
  return (
    <div className="design-container">
      ...
      <div className="content-section">
        ...
        <div className="services-grid">
          ...
          <div className="service-item">
            <h3 className="service-title">Reliable Support</h3>
            <p className="service-description">Ongoing help whenever you need updates or fixes.</p>
          </div>
          <div className="service-item">
            <h3 className="service-title">Reliable Support</h3>
            <p className="service-description">Ongoing help whenever you need updates or fixes.</p>
      ...
      <button className="cta-button">
        <span className="button-text">Explore Web Design Services</span>
      </button>
