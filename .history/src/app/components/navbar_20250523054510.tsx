    ...
    <>
      ...
      <style>{`
        * {
        ...
        /* Service slider overlay control */
        ...
        /* Large screens - even wider slider */
        ...
        @media (max-width: 768px) {
          ...
          /* SERVICE SLIDER MOBILE OPTIMIZATIONS - COMPLETELY REDESIGNED */
          .service-slider {
            width: 100vw;
            height: 100vh;
            right: -100%;
            ...
            z-index: 1003;
            background: linear-gradient(180deg, #050922 0%, #0a1240 50%, #0d1540 100%);
          }
          ...
          .service-slider-item {
            padding: 1.5rem;
            background: linear-gradient(135deg, rgba(255, 255, 255, 0.08) 0%, rgba(0, 188, 212, 0.08) 100%);
