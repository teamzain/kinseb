...
import { 
  ...
  SiElastic, SiTensorflow, SiFigma, SiAmazon
} from 'react-icons/si';
  ...
  return (
    <section 
      ...
      style={{
        ...
        padding: '8px 0', // Reduced padding from 16px to 8px
        margin: '0',
        position: 'relative',
    ...
    >
      ...
      <div className="sr-only">
        Technology stack featuring various programming languages and tools
      </div>
        ...
        {allTechnologies.map((tech, index) => (
          <div key={index} 
            ...
            style={{
              ...
              height: 'clamp(24px, 4vw, 36px)', // Reduced height from 36-48px to 24-36px
          ...
          >
            <tech.Icon 
              style={{
                fontSize: 'clamp(24px, 3vw, 32px)', // Reduced font size from 32-42px to 24-32px
                color: '#FFFFFF',
      ...
      <style jsx>{`
        ...
        .tech-icon:hover {
          transform: translateY(-5px) scale(1.2); // Reduced vertical movement from -8px to -5px
        }
        ...
        .tech-icon:hover::after {
          content: '';
          position: absolute;
          bottom: -8px; // Reduced distance from -12px to -8px
          left: 50%;
          transform: translateX(-50%);
          width: 4px; // Reduced size from 6px to 4px
          height: 4px; // Reduced size from 6px to 4px
          background: #fff;
          border-radius: 50%;
        ...
        @media (max-width: 480px) {
          .tech-icon {
            margin: 0 8px !important; // Reduced margin from 10px to
            margin: 0 8px !important; // Reduced margin from 10px to 8px
          }
        }
      `}</style>
    </section>
