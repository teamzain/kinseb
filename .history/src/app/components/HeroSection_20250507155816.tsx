    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* Text alignment changes based on screen size - moved more left on desktop */}
          <div style={{
            maxWidth: '48rem', // Increased from 42rem to 48rem
            margin: isMobile ? '0 auto' : '0 0 0 0', // Removed left margin on desktop
            ...
            <div style={{
              ...
              <h1 style={{
                ...
                {isMobile ? (
                  ...
                  <>
                    Building&nbsp;<span style={{ color: 'rgb(34, 211, 238)' }}>Websites</span>&nbsp;That Drive Growth
                  </>
                )}
              </h1>
            </div>
            {/* Description text - increased max width */}
            <p style={{
              color: 'rgb(229, 231, 235)',
              maxWidth: '42rem', // Increased from 36rem to 42rem
              ...
              websites that help your business establish a powerful online presence.
              Let your brand stand out with designs tailored for results and exceptional user experience.
            </p>
