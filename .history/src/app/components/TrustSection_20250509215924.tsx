  ...
  return (
    <>
      ...
      <div style={{
        position: 'relative',
        width: '100%',
        minHeight: isMobile ? '980px' : '700px',
        ...
        <motion.div 
          ...
          style={{
            ...
            width: '100%',
            textAlign: 'center',
            top: isMobile ? '30px' : '40px',  // Adjusted for mobile
            padding: '0 20px',
            marginBottom: '0',
            boxSizing: 'border-box',
        ...
        >
          <h2 className={poppins.className} style={{
            fontStyle: 'normal',
            fontWeight: '600',
            fontSize: isMobile ? '38px' : '48px',  // Slightly smaller on mobile but still prominent
            lineHeight: isMobile ? '46px' : '56px', // Adjusted line height for mobile
          ...
          <h2 className={poppins.className} style={{
            fontStyle: 'normal',
            fontWeight: '600',
            fontSize: isMobile ? '34px' : '48px',  // Slightly smaller on mobile but still prominent
            lineHeight: isMobile ? '46px' : '56px', // Adjusted line height for mobile
            letterSpacing: '-0.03em',
            color: '#FFFFFF',
            marginTop: '5px',
