    ...
    >
      ...
      <div 
        ...
        style={{
          ...
          padding: '6px 0', // Reduced from 12px to 6px
        }}
        ...
        {allTechnologies.map((tech, index) => (
          <div key={index} 
            ...
            style={{
              ...
              height: 'clamp(30px, 4vw, 38px)', // Reduced from clamp(36px, 5vw, 48px)
          ...
          >
            <tech.Icon 
              style={{
                fontSize: 'clamp(26px, 3.5vw, 36px)', // Reduced from clamp(32px, 4vw, 42px)
                color: '#FFFFFF',
      ...
      <style jsx>{`
        ...
        .tech-icon:hover {
          transform: translateY(-5px) scale(1.15); /* Reduced Y translation from -8px to -5px */
        }
