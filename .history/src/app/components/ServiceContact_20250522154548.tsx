...
const HeroSection = () => {
  ...
  useEffect(() => {
    if (isVisible && mockup1Ref.current && mockup2Ref.current) {
      // Add subtle floating animation to mockup cards
      const floatAnimation = () => {
        ...
        if (mockup1 && mockup2) {
          ...
          const animate = (timestamp: number) => {
            ...
            const translateY1 = Math.sin(elapsed / 4000) * 4; // Subtle vertical movement
            const translateY2 = Math.sin(elapsed / 4500 + Math.PI/3) * 5;
  ...
  return (
    <>
      <Head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&family=Lato:wght@300;400;600;700&display=swap"
          rel="stylesheet"
          media="print"
      ...
      >
        <div className="container">
          ...
          >
            ...
            {/* Content Layout - Text on Left, Mockup Images on Right */}
            <div className="content-layout">
              ...
              {/* Right Side - Straight Website Mockups */}
              <div className="mockups-container">
                {/* Website Mockup 1 - Background (Straight) */}
                <div 
                  ref={mockup1Ref}
                  className={`mockup-image mockup-1 ${isVisible ? 'animate-mockup-1' : ''}`}
                >
                  <img src="/images/89.png" alt="Website Design Example 1" />
                  <div className="image-glow"></div>
                </div>

                {/* Website Mockup 2 - Foreground (Straight) */}
                <div 
                  ref={mockup2Ref}
                  className={`mockup-image mockup-2 ${isVisible ? 'animate-mockup-2' : ''}`}
                >
      ...
      <style jsx>{`
        ...
        /* Text Content - Left Side - Improved Formation */
        .text-content {
          z-index: 2;
          position: relative;
          display: flex;
        ...
        .highlight {
          ...
          background: linear-gradient(135deg, #0D98BA 0%, #0B7A94 100%);
        ...
        .primary-button:hover {
          ...
          box-shadow: 0 8px 20px rgba(13, 152, 186, 0.3);
          background: #0B7A94;
        }
        ...
        .image-glow {
          ...
          right: 0;
          bottom: 0;
          background: radial-gradient(circle at center, rgba(13, 152, 186, 0.1) 0%, transparent 70%);
          opacity: 0;
        ...
        .mockup-image:hover .image-glow {
          opacity: 1;
        }

        /* Mockup 1 - Background (Straight) */
        .mockup-1 {
          width: 300px;
          height: 380px;
          right: 100px;
