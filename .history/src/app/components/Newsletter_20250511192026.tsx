    ...
    >
      ...
      <style jsx>{`
        ...
        .background-wrapper::before {
          ...
          filter: brightness(0.9) saturate(1.2); /* Adjust to match the image */
        }
        ...
        .overlay {
          ...
          top: 0;
          left: 0;
          background: rgba(4, 9, 29, 0.85); /* Darker overlay to match the image */
          z-index: 2;
        }
        ...
        .form-container {
          ...
          border: 1px solid rgba(125, 129, 141, 0.4);
