...
const WebDevelopmentComponent = () => {
  ...
  const getButtonStyle = (color, isActive = false) => ({
    ...
    boxShadow: isActive ? `0 4px 12px rgba(${parseInt(color.slice(1, 3), 16)}, ${parseInt(color.slice(3, 5), 16)}, ${parseInt(color.slice(5, 7), 16)}, 0.4)` : 'none',
  });
      ...
      <div style={rowContainerStyle}>
        ...
        {isMobile ? (
          <div style={{ 
            ...
            {/* Continuous vertical timeline that connects all services */}
            <div style={{
              position: 'absolute',
              left: '19px', // Aligned with individual service vertical lines
              top: '0',
              width: '4px',
              height: '100%',
              backgroundColor: '#2A3958', // Neutral color that complements the dark background
              zIndex: 0,
              borderRadius: '2px',
            }}></div>
            ...
            {services.map((service, index) => (
              <div 
                ...
                style={{
                  width: '100%',
                  padding: '25px 20px 25px 30px', // Added left padding for the vertical line
                  position: 'relative',
                  display: 'flex',
              ...
              >
                {/* Colored circle indicator that connects to the main vertical line */}
                <div style={{
                  width: '20px',
                  height: '20px',
                  borderRadius: '50%',
                  ...
                  zIndex: 2,
                  boxShadow: `0 0 0 5px rgba(${parseInt(service.color.slice(1, 3), 16)}, ${parseInt(service.color.slice(3, 5), 16)}, ${parseInt(service.color.slice(5, 7), 16)}, 0.2)`,
                }}></div>
          ...
          <div style={{ 
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                {/* Button with better positioning and animation */}
                {hoveredSection === service.key && (
                  <div style={{
                    ...
                    <a 
                      href="#" 
                      style={getButtonStyle(service.color)}
                      onMouseEnter={(e) => {
                        e.currentTarget.style.backgroundColor = service.color;
                        e.currentTarget.style.color = '#04091D';
                        e.currentTarget.style.transform = 'scale(1.05)';
                        e.currentTarget.style.boxShadow = `0 4px 12px rgba(${parseInt(service.color.slice(1, 3), 16)}, ${parseInt(service.color.slice(3, 5), 16)}, ${parseInt(service.color.slice(5, 7), 16)}, 0.4)`;
                      }}
                      onMouseLeave={(e) => {
