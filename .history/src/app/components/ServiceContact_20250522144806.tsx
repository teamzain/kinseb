  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        left: '69px',
        top: '90px',
        background: `linear-gradient(270deg, rgba(4, 9, 29, 0) -264.67%, rgba(4, 9, 29, 0.7) 100%), url('/api/placeholder/1302/520'), rgba(172, 255, 36, 0.2)`,
        ...
        <div style={{
          ...
          <div style={{
            ...
            left: '798px',
            top: '50px',
            background: `url('/api/placeholder/300/2278')`,
            backgroundSize: 'cover',
            backgroundPosition: 'center',
          ...
          <div style={{
            ...
            left: '1060px',
            top: '100px',
            background: `url('/api/placeholder/284/1740')`,
            backgroundSize: 'cover',
            backgroundPosition: 'center',
            borderRadius: '10px',
            overflow: 'hidden',
