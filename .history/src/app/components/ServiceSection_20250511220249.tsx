  ...
  return (
    <div style={styles.designContainer}>
      <div style={styles.designWordStack}>
        ...
        <span style={{...styles.designWord,  top: '80px'}}>DESIGN</span>
        <span style={{...styles.designWord,color:'white', top: '134px'}}>DESIGN</span>
        <span style={{...styles.designWord,color:'white', top: '164px'}}>DESIGN</span>
        <span style={{...styles.designWord,color:'white', top: '196px'}}>DESIGN</span>
        <span style={{...styles.designWord,color:'white',top: '226px'}}>DESIGN</span>
      </div>
