    ...
    <>
      ...
      <style>{`
        * {
        ...
        .service-slider-tabs {
          width: 200px; /* Reduced to accommodate 500px total width */
        ...
        .service-slider-content::-webkit-scrollbar {
          width: 4px;
        }

        .service-slider-content::-webkit-scrollbar-track {
          background: transparent;
        }

        .service-slider-content::-webkit-scrollbar-thumb {
          background: rgba(0, 188, 212, 0.3);
          border-radius: 2px;
        }

        .service-slider-content::-webkit-scrollbar-thumb:hover {
        ...
        .service-slider-panel {
          display: none;
          animation: slideInFade 0.6s cubic-bezier(0.23, 1, 0.32, 1);
        }
        ...
        /* Service items grid - IMPROVED - RESPONSIVE GRID */
        ...
        /* Ensure service slider appears behind menu sidebar */
        .service-slider-open .service-slider {
          z-index: 998; /* Behind menu sidebar */
        }

        /* Menu sidebar should be on top */
        .menu-side {
          z-index: 1000; /* Higher than service slider */
        }
        ...
        /* Desktop: Service slider positioning */
        @media (min-width: 769px) {
          /* Service slider slides from right with 500px width */
          .service-slider {
            width: 500px;
            left: 100%;
          }
          ...
          /* Large screens get even more width */
        ...
        @media (max-width: 768px) {
          ...
          /* SERVICE SLIDER MOBILE - FULL SCREEN FIXED */
          .service-slider {
            position: fixed;
            top: 0;
            ...
            height: 100vh;
            z-index: 1001; /* Above menu on mobile */
            flex-direction: column;
            border-radius: 0;
            margin-left: 0;
            margin-right: 0;
          ...
          .service-slider.open {
            left: 0; /* Slide to cover full screen */
            transform: translateX(0);
          }
