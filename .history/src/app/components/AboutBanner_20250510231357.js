    ...
    >
      ...
      <div style={{
        ...
        <div style={{
          ...
          alignItems: 'center',
          width: '100%',
          marginTop: isSmallMobile ? '20px' : isMobile ? '50px' : isTablet ? '40px' : '60px',
        }}>
          ...
          <h1 
            style={{
              ...
              textAlign: 'center',
              color: '#FFFFFF',
              margin: isSmallMobile ? '15px 0 0' : isMobile ? '20px 0 0' : isTablet ? '25px 0 0' : '1px 0 0',
        ...
        <div style={{
          ...
          marginTop: isSmallMobile ? '60px' : isMobile ? '80px' : isTablet ? '100px' : '20px',
