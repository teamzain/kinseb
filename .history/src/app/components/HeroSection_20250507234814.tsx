  ...
  useEffect(() => {
    ...
    const ensureSmoothAnimation = (columnRef: { current: HTMLDivElement | null }) => {
      ...
      const handleImageLoad = () => {
        ...
        // Increased multiplier to ensure smoother continuous animation
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div className="content-container" style={{
            padding: '70px 50px', // Adjusted padding to position content correctly
            color: 'white',
            height: '100%',
            display: 'flex',
            ...
            <h1 className="heading-animation" style={{ fontSize: '52px', marginBottom: '25px', fontWeight: '700', lineHeight: 1.1 }}>
              Building <span style={{ color: '#0099cc' }}>Websites</span> That Drive Growth
            </h1>
