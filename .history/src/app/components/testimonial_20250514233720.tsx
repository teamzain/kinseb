...
const TestimonialSection = () => {
  // Enhanced testimonials with more specific details for SEO
  ...
  return (
    <>
      ...
      {/* Structured Data for Reviews - helps with SEO and rich snippets */}
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "review": testimonials.map((testimonial, index) => ({
              ...
              "publisher": {
                "@type": "Organization",
                "name": testimonial.company || "Client Company"
              }
            }))
          })
        }}
        ...
        <div className="testimonial-container">
          <div className="testimonial-header">
            ...
            <p className="testimonial-description">
              Read authentic testimonials from our valued clients who have experienced success with our services. These reviews reflect our commitment to excellence and customer satisfaction.
            </p>
          </div>
          ...
          >
                  ...
                  <div className="testimonial-card">
                    ...
                    <div className="person-container">
                      ...
                      <div className="avatar">
                        <div className="avatar-content" aria-hidden="true">
                      ...
                      <div className="person-info">
                        ...
                        {/* Role & Company for better SEO */}
                        <div className="person-role">
                          {testimonials[card.index].role}
                          {testimonials[card.index].company && (
                            <span> at {testimonials[card.index].company}</span>
                          )}
                        </div>
                      </div>
                    </div>
                    
                    {/* Testimonial content - wrapped in blockquote for semantic SEO */}
                    <blockquote className="testimonial-text">
                      {testimonials[card.index].text}
                    </blockquote>
                    
                    {/* Quote mark (replaced with placeholder) */}
                    <div className="quote-placeholder" aria-hidden="true">
                      <img 
                        src="/images/48.png" 
                        alt="Quote icon" 
            ...
            {/* Navigation arrows - Added with proper ARIA labels */}
            <button 
          ...
          <div className="navigation-dots" role="tablist" aria-label="Testimonial navigation">
            {testimonials.map((testimonial, index) => (
              <button 
                ...
                title={`View ${testimonial.name}'s testimonial`}
              ></button>
            ))}
          </div>
        </div>
