      ...
      <style jsx global>{`
        * {
        ...
        @media (max-width: 768px) {
         ...
         /* Improved close button for better visibility and touch target */
.menu-close {
  width: 30px;  /* Change to same value */
  height: 30px; /* Change to same value */
  border-radius: 50%; /* Ensure it's 50% for perfect circle */
  display: flex;
  align-items: center;
  justify-content: center;
  background-color: #091135; /* Keep existing background color */
}

/* Fix the X button centering issue */
.menu-close svg {
  width: 18px;
  height: 18px;
  position: relative;
