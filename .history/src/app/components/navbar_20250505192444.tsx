...
// Client-side interactive component for the hamburger menu
const ClientSideMenu = ({ navigationLinks, activeLink }: { 
...
// Server-side rendered Navbar component
const Navbar = ({ currentPath = '/' }: { currentPath?: string }) => {
  // Determine active link based on current path
  let activeLink = 'home';
  
  if (currentPath.startsWith('/about')) activeLink = 'about';
  else if (currentPath.startsWith('/services')) activeLink = 'services';
  else if (currentPath.startsWith('/portfolio')) activeLink = 'portfolio';
  else if (currentPath.startsWith('/contact')) activeLink = 'contact';
