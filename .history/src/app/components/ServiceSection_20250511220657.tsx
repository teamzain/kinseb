...
const DesignExperienceSection: React.FC<DesignExperienceSectionProps> = ({ 
  ...
  // Design word stack configuration - designed to match the reference image
  const designWords = [
    { color: '#0D98BA', top: '0px', opacity: 1, transform: 'translateY(0)', textShadow: '0 0 2px rgba(13, 152, 186, 0.8)' },
    { color: '#0D98BA', top: '30px', opacity: 0.7, transform: 'translateY(0)', textShadow: 'none' },
    { color: '#FFFFFF', top: '60px', opacity: 0.6, transform: 'translateY(0)', textShadow: 'none' },
    { color: '#FFFFFF', top: '90px', opacity: 0.4, transform: 'translateY(0)', textShadow: 'none' },
    { color: '#FFFFFF', top: '120px', opacity: 0.2, transform: 'translateY(0)', textShadow: 'none' },
    { color: '#FFFFFF', top: '150px', opacity: 0.1, transform: 'translateY(0)', textShadow: 'none' },
  ];

  return (
    <div ref={sectionRef} style={styles.designContainer}>
      {/* Stacked "DESIGN" words */}
      <div 
        ...
        {designWords.map((design, index) => (
          <span 
            ...
            style={{
              ...
              textShadow: design.textShadow || 'none',
              animation: isVisible ? `fadeIn 0.5s ease ${index * 0.1}s forwards` : 'none',
              WebkitTextStroke: index === 0 ? 'none' : index === 1 ? '1px #0D98BA' : '1px rgba(255, 255, 255, 0.5)',
            }}
