      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              width: isMobile ? '90px' : '100px', // Slightly larger image container
              ...
              <img 
                ...
                alt="WordPress" 
                style={{
                  width: isMobile ? '90px' : '130px', // Increased image size
        ...
        <div style={{
          ...
          alignItems: 'center',
          textAlign: isMobile ? 'left' : 'center',
          marginTop: isMobile ? '-25px' : '1.25px', // Adjusted spacing between cards
          ...
          {isMobile && (
            <div style={{
              width: '5px',
              height: '140%', // Increased height for better connection
              position: 'absolute',
              left: '20px', // Moved slightly to the right
              top: '15px', // Moved down as requested
        ...
        <div style={{
          ...
          alignItems: 'center',
          textAlign: isMobile ? 'left' : 'center',
          marginTop: isMobile ? '-25px' : '20px', // Adjusted spacing between cards
          marginLeft: isMobile ? '0' : '-20px',
          padding: isMobile ? '20px 15px 45px' : '0', // Increased padding for better spacing
          opacity: isVisible ? 1 : 0,
          transform: isVisible ? 'translateY(0)' : 'translateY(50px)',
        ...
        <div style={{
          ...
          marginTop: isMobile ? '-25px' : '1.25px', // Adjusted spacing between cards
          marginLeft: isMobile ? '0' : '-20px',
          padding: isMobile ? '20px 15px 25px' : '0', // Added bottom padding for mobile
          opacity: isVisible ? 1 : 0,
          transform: isVisible ? 'translateY(0)' : 'translateY(50px)',
