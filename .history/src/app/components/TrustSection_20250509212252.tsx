...
const TrustSection = () => {
  ...
  // Pointer triangle for active tab - Removed as it's now inline
  ...
  return (
    <div style={{
      position: 'relative',
      width: '100%',
      minHeight: isMobile ? '980px' : '700px', // Increased height on mobile to accommodate new layout
      background: 'linear-gradient(180deg, #04091D 39.13%, #0D98BA 263.77%)',
      padding: '0',
      boxSizing: 'border-box',
      overflow: 'hidden'
    }}>
      {/* Main Heading - Now centered with adjusted positioning */}
      <motion.div 
      ...
      <div style={{
        ...
        maxWidth: '1100px',
        left: '50%',
        top: isMobile ? '140px' : '180px', // Increased top value on mobile to avoid overlap with heading
        ...
        >
          {/* Sliding Indicator - Visible on all screens but with different positioning */}
          <motion.div 
            initial={false}
            animate={{
              left: isMobile ? `${(activeTab * 160) + 8}px` : getIndicatorPosition(),
              width: isMobile ? '160px' : `${100 / tabs.length}%`
            }}
            transition={{
              type: 'spring',
              stiffness: 300,
          ...
          {tabs.map((tab) => (
            ...
            >
              <h3 className={poppins.className} style={{
                ...
                whiteSpace: 'pre-line' // Ensure line breaks work in title
              }}>
                {tab.title}
              </h3>
              ...
              {tab.id === activeTab && (
                <svg 
                  ...
                  style={{
                    position: 'absolute',
                    bottom: '-10px', // Moved up slightly to connect with blue line
                    left: '50%',
                    transform: 'translateX(-50%)',
                    zIndex: 2
                  }}
      ...
      <div style={{
        ...
        height: '4px',
        left: '50%',
        top: isMobile ? '210px' : '250px', // Adjusted to match new tab positioning
        transform: 'translateX(-50%)',
        background: '#0D98BA',
        borderRadius: '10px',
        zIndex: 1
      ...
      {/* Downward Triangle Indicator - Only visible on laptop/desktop for selected tab */}
      {!isMobile && (
        <motion.div 
          initial={false}
          animate={{
            left: `calc(${getIndicatorPosition()} + ${(100 / tabs.length) / 2}%)`,
          }}
          transition={{
            type: 'spring',
            stiffness: 300,
          ...
          style={{
            ...
            height: '0',
            top: '250px',
            marginLeft: '-15px', // Adjust to half the width of the triangle
            zIndex: 2
          }}
        >
          <svg 
      ...
      <div style={{
        ...
        top: isMobile ? '230px' : '280px', // Adjusted to match new positioning
        left: '50%',
        transform: 'translateX(-50%)',
        boxSizing: 'border-box',
        padding: '0 20px'
          ...
          >
            ...
            >
              ...
              <motion.p 
                ...
                style={{
                  fontWeight: '400',  // Changed from 500 to 400 since Lato only supports 100, 300, 400, 700, 900
