    ...
    <>
      ...
      <style jsx global>{`
        * {
        ...
        /* Hamburger container - only one menu toggle */
        .hamburger-container {
          display: flex;
          align-items: center;
        ...
        >
          ...
          >
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M13 1L1 13" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M1 1L13 13" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </button>

          <div className="menu-content">
            {/* Logo in the menu - Just the image */}
