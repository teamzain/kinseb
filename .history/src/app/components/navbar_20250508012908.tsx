...
{ href: "/services", label: "Services", id: "services", icon: "/images/service.svg" },
...
/* Menu panel - Updated with fixed logo and close button positioning */
.menu-side {
  position: fixed;
  top: 0;
  right: -340px;
...
/* Close button in menu - FIXED positioning */
.menu-close {
  position: absolute;
  top: 1.5rem;
  right: 1.5rem;
...
/* Menu logo styling - FIXED to be on its own row */
.menu-logo {
  margin-bottom: 2rem;
  display: block;
  width: 100%;
...
>
  {/* Menu logo - Now in a separate block */}
  ...
  {/* Close button (X) - Now positioned absolutely */}
  <button 
