...
const FigmaDesignComponent = () => {
  ...
  useEffect(() => {
    ...
    // Improved scroll animation observer with options for better mobile experience
  ...
  const getResponsiveStyles = () => {
    ...
    if (typeof window !== 'undefined' && viewportHeight > 0 && viewportWidth > 0) {
      ...
      const animationDelay = activeCard * 0.1;
  ...
  return (
    <div style={responsiveStyles.frame} ref={sectionRef} className="scroll-reveal-section">
      ...
      <style jsx global>{`
        ...
        /* Improved more granular responsive breakpoints */
