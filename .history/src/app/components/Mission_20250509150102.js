...
const FigmaDesignComponent = () => {
  ...
  useEffect(() => {
    ...
    const calculateScale = () => {
      // Base design height is 980px (approximate total component height)
      const baseHeight = 980;
      const viewportHeight = window.innerHeight;
      const newScale = Math.min(1, viewportHeight / baseHeight);
      setScale(newScale);
    };
  ...
  return (
    <div style={containerStyle}>
      <div style={contentStyle}>
        <h2 style={styles.mainHeading} className={poppins.className}>
            ...
            {cards.map((card, index) => (
              ...
              >
                ...
                <div style={styles.textContainer}>
                  <h2 style={styles.h2} className={poppins.className}>{card.title}</h2>
                  <h3 style={styles.heading} className={poppins.className}>
                    {card.heading.split('\n').map((line, i) => (
