      ...
      <div style={rowContainerStyle}>
        ...
        {isMobile || isTablet ? (
          ...
          <div style={{ 
            width: '100%',
            position: 'relative',
            minHeight: '400px', // Reduced height for closer placement
            display: 'flex',
          }}>
            ...
            {services.map((service, index) => (
              <div 
                ...
                style={{
                  ...
                  transform: isVisible ? 'translateY(0)' : 'translateY(20px)',
                  transition: `opacity 0.8s ease-out ${0.1 * (index + 1)}s, transform 0.8s ease-out ${0.1 * (index + 1)}s`,
                  height: '400px', // Reduced height for closer placement
                }}
              >
                ...
                {service.isOdd ? (
                  <>
                    ...
                    <div style={{
                      ...
                      paddingBottom: '15px', // Reduced padding to be closer to line
                    }}>
                      <img 
                        src={service.imagePath} 
                        alt={service.name} 
                    ...
                    <div style={{
                      ...
                      flexDirection: 'column',
                      justifyContent: 'flex-start',
                      paddingTop: '15px', // Reduced padding to be closer to line
                      textAlign: 'center',
                    }}>
                      <h3 style={{ 
                        fontSize: '26px', 
