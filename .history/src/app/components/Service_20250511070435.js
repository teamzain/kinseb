    ...
    <div style={containerStyle}>
      ...
      <div style={rowContainerStyle}>
        ...
        {isMobile ? (
          ...
          // Tablet Layout with alternating image/text positions as requested
          <div style={{ width: '100%', position: 'relative' }}>
            ...
            <div style={{
              ...
              {/* WordPress (left - odd) - Image above line, text below */}
              <div style={{
                width: '50%',
                padding: '0 20px',
                boxSizing: 'border-box',
              ...
              {/* Shopify (right - even) - Text above line, image below */}
              <div style={{
                width: '50%',
                padding: '0 20px',
                boxSizing: 'border-box',
            ...
            <div style={{
              ...
              {/* Point of Sale (left - odd) - Image above line, text below */}
              <div style={{
                width: '50%',
                padding: '0 20px',
                boxSizing: 'border-box',
              ...
              {/* Custom (right - even) - Text above line, image below */}
              <div style={{
                width: '50%',
                padding: '0 20px',
                boxSizing: 'border-box',
          ...
          // Desktop layout with hover effects and buttons
          <div style={{ 
            width: '100%',
            position: 'relative',
            minHeight: '400px',
