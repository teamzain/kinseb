          ...
          <ul className="menu-links">
            {navigationLinks.map((link) => (
              <li className="menu-item" key={link.id}>
                {link.hasDropdown ? (
                  <>
                  // Update 1: Update the Services dropdown component around line 629-662
// Replace the existing dropdown implementation with this
<div 
...
>
  ...
  <span 
    className={`dropdown-toggle ${openDropdown === link.id ? 'open' : ''}`}
    onClick={(e) => {
      e.preventDefault();
      e.stopPropagation();
