        ...
        <div className="services-container" style={{
          ...
          >
            ...
            <style jsx>{`
              ...
              .service-card {
                opacity: ${isMobile ? 0 : (activeCardIndex === 0 ? 1 : 0.6)};
                transform: ${isMobile ? 'translateY(20px)' : (activeCardIndex === 0 ? 'scale(1)' : 'scale(0.95)')};
            ...
            <div className="services-cards">
              {cards.map((card, index) => (
                <div 
                  ...
                  aria-hidden={activeCardIndex !== index && !isMobile}
                >
                  <div style={{
                    display: 'flex',
                    alignItems: 'center',
