      ...
      <div style={{
        ...
        <motion.div 
          ...
          style={{
            ...
            width: '100%',
            textAlign: 'center',
            top: '40px',  // Same for all devices
            padding: '0 20px',
            marginBottom: '0',  // Same for all devices
            boxSizing: 'border-box',
        ...
        >
          <h2 className={poppins.className} style={{
            fontStyle: 'normal',
            fontWeight: '600',
            fontSize: '48px',  // Same size for all devices
            lineHeight: '56px', // Same line height for all devices
