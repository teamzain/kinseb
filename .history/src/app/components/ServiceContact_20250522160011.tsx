    ...
    <>
      ...
      <style jsx>{`
        ...
        .mockup-card-2 .mockup-image img {
          margin-top: -50px; /* Adjust this value to show the desired part of the screenshot */
        }
        ...
        /* Updated mockup positioning - straightened and second card moved up */
        .mockup-card-1 {
          width: 300px;
          height: 380px;
          right: 120px;
        ...
        .mockup-card-2 {
          ...
          height: 200px;
          right: -60px;
          top: -80px; /* Moved up from -200px to -80px */
          z-index: 1;
        }
        ...
        @media (max-width: 768px) {
          ...
          .mockup-card-2 {
            ...
            height: 230px;
            right: 10px;
            top: 10px; /* Moved up from 50px to 10px */
          }
        }
        ...
        @media (max-width: 480px) {
          ...
          .mockup-card-2 {
            ...
            height: 160px;
            right: 10px;
            top: 20px; /* Moved up from 50px to 20px */
          }
        }
