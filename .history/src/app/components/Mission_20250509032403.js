  ...
  const cards = [
    {
      ...
      backgroundImage: "/api/placeholder/1300/520" // Replace with your actual image path
    },
    {
      title: "Vision",
            ...
            {cards.map((card, index) => (
              <div 
                ...
                style={{
                  ...
                  backgroundImage: `linear-gradient(270deg, rgba(4, 9, 29, 0.9) 25.96%, rgba(4, 9, 29, 0.85) 43.56%, rgba(4, 9, 29, 0.8) 72.04%), 
                    ...
                    {card.heading.split('\n').map((line, i) => (
                      <React.Fragment key={i}>
                        ...
                        {i === 0 && line.includes('Clean') && 
                          <span style={styles.solutions}> Solutions</span>}
                        {i === 0 && line.includes('Digital') && i !== card.heading.split('\n').length - 1 && 
                          <span style={styles.solutions}> Excellence</span>}
                        {i === 0 && line.includes('Lasting') && 
                          <span style={styles.solutions}> Relationships</span>}
                      </React.Fragment>
                    ))}
                  </h3>
...
const styles = {
  ...
  textContainer: {
    ...
    zIndex: 2, // To ensure text stays above the background
  },
  h2: {
    position: 'absolute',
    width: '782px',
