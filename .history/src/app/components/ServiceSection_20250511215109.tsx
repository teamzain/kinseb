  ...
  return (
    <div style={styles.designContainer}>
      <div style={styles.designWordStack}>
        ...
        <span style={{...styles.designWord, top: '164px'}}>DESIGN</span>
        <span style={{...styles.designWord, top: '196px'}}>DESIGN</span>
        <span style={{...styles.designWord,top: '226px'}}>DESIGN</span>
      </div>
