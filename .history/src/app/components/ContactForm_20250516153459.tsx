...
export default function LandingPage() {
  ...
  return (
    <>
      {/* SEO Meta Tags */}
      <Head>
        <title>Transform Your Ideas Into Impactful Digital Products | Your Company</title>
        <meta name="description" content="Turn your business ideas into powerful digital products. Get in touch with our expert team to start a conversation about your project needs." />
        <meta name="keywords" content="digital products, web development, contact us, project collaboration, custom software, digital transformation" />
        ...
        <meta property="og:title" content="Transform Your Ideas Into Impactful Digital Products" />
        <meta property="og:description" content="Get in touch with our expert team to start a conversation about your project needs." />
        <meta property="og:image" content="https://yourwebsite.com/og-image.jpg" />
        
        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:url" content="https://yourwebsite.com/contact" />
        <meta name="twitter:title" content="Transform Your Ideas Into Impactful Digital Products" />
        <meta name="twitter:description" content="Get in touch with our expert team to start a conversation about your project needs." />
      ...
      <main className="landing-container" role="main" aria-labelledby="main-heading">
        ...
        >
          <div className="content-wrapper">
            ...
            <div className="header-content">
              ...
              <h1 id="main-heading" className={`main-heading ${poppins.className} animate-item`}>
            ...
            <div className="contact-info animate-on-scroll">
              ...
              <div className="social-icons">
                <a href="https://twitter.com/yourcompany" className="social-icon" aria-label="Follow us on Twitter" rel="noopener">
                  <Image 
                ...
                <a href="https://facebook.com/yourcompany" className="social-icon" aria-label="Follow us on Facebook" rel="noopener">
                  <Image 
                ...
                <a href="https://instagram.com/yourcompany" className="social-icon" aria-label="Follow us on Instagram" rel="noopener">
                  <Image 
                ...
                <a href="https://linkedin.com/company/yourcompany" className="social-icon" aria-label="Connect with us on LinkedIn" rel="noopener">
                  <Image 
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="contact-form" name="contact" aria-label="Contact form">
        ...
        <style jsx>{`
          ...
          /* Form Container Styles - REDUCED HEIGHT HERE */
          .form-container {
            flex: 1;
            max-width: 50%;
            min-height: 55vh; /* Decreased from 65vh - approximately 10vh less */
          ...
          .form-textarea {
            width: 100%;
            min-height: 5.5rem; /* Slightly reduced from 6.25rem */
            background: rgba(4, 9, 29, 0.9);
            border: 1px solid #07435D;
            backdrop-filter: blur(6px);
            border-radius: 8px;
          ...
          @media (max-width: 1200px) {
            ...
            .form-container {
              padding: 2rem;
              min-height: 50vh; /* Decreased from 60vh */
            }
          ...
          @media (max-width: 1024px) {
            ...
            .form-container {
              padding: 1.75rem;
              min-height: 45vh; /* Decreased from 55vh */
            }
