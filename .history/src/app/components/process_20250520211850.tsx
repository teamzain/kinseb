  ...
  const getResponsiveStyles = () => {
    ...
    const styles = {
      ...
      numberContainer: {
        paddingTop: '0',
        width: '100%',
        textAlign: 'center' // Added to center the section headings
      },
      number: {
        fontSize: '3rem',
        marginBottom: '4px',
        textAlign: 'center' // Added to center the section numbers
      },
      title: {
        fontSize: '1.4rem',
        minHeight: '2rem',
        textAlign: 'center' // Added to center the section titles
      },
      description: {
        fontSize: '0.95rem',
        lineHeight: '1.4',
        marginTop: '7px' // Added margin-top to description
      },
      bulletPoint: {
        fontSize: '0.95rem',
        marginBottom: '10px',
        paddingLeft: '20px' // Reduced to decrease gap between bullet and text
      },
      progressContainer: {
        marginTop: '0',
        marginBottom: '5px'
    ...
    if (deviceType === 'tablet') {
      return {
        ...
        description: {
          ...
          fontSize: '1rem',
          marginBottom: '9px',
          paddingLeft: '20px' // Reduced padding for tighter bullet spacing
        },
        progressContainer: {
      ...
      >
                    ...
                    <div style={{ 
                      ...
                      <div 
                        style={{ 
                          ...
                          textAlign: styles.numberContainer.textAlign, // Center the heading
                        }}
                      >
                        {/* Number */}
                        <div
                          style={{
                            ...
                            textAlign: styles.number.textAlign, // Center the number
                          }}
                          onMouseEnter={handleMouseEnter}
                          onMouseLeave={handleMouseLeave}
                        >
                        ...
                        <h2
                          style={{
                            ...
                            lineHeight: '1.2',
                            textAlign: styles.title.textAlign, // Center the title
                          }}
                          onMouseEnter={handleMouseEnter}
                          onMouseLeave={handleMouseLeave}
                        >
                        ...
                        {step.bulletPoints.map((point, pointIndex) => (
                          <li
                            ...
                            style={{
                              ...
                              paddingLeft: styles.bulletPoint.paddingLeft, // Move bullets to the right
                              position: 'relative'
                            }}
                          >
                            {/* Removing the blue dot and using standard bullet style */}
                            {point}
                          </li>
                        ))}
                      </ul>
        ...
        <style>
          {`
            ...
            /* Add standard bullet styling with reduced gap */
            .space-y-2 li {
