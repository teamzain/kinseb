    ...
    },
{
  ...
  },
  {
...

    {
      ...
      "duration": "4-8 weeks",
      "featured": true,
      "image": "/images/seo-strategy.jpg",
      "faq": [
  {
    "id": "section1",
    "title": "How is SEO strategy different from SEO services?",
    "description": "SEO strategy provides the comprehensive roadmap and planning for all SEO activities, while SEO services execute specific tactics. Strategy ensures all efforts align with business goals."
  },
  {
    "id": "section2",
    "title": "How long does it take to see SEO results?",
    "description": "SEO is a long-term investment. Initial improvements may be seen in 3-6 months, with significant results typically occurring in 6-12 months of consistent strategy implementation."
  },
  {
    "id": "section3",
    "title": "Do you provide competitor analysis?",
    "description": "Yes, comprehensive competitor analysis is a key component of our SEO strategy, helping identify opportunities and understand the competitive landscape."
  },
  {
    "id": "section4",
    "title": "Can you adapt strategy for algorithm changes?",
    "description": "Our strategies are built to be adaptable and we continuously monitor algorithm changes, adjusting tactics while maintaining focus on long-term sustainable growth."
  }
],
      "processSteps": [
        {
      ...
      "whyYourBusinessNeeds": {
        "paragraph": "A comprehensive SEO strategy provides the roadmap for achieving sustainable organic growth and competitive advantage. Strategic planning ensures your SEO efforts are aligned with business goals, efficiently utilize resources, and deliver measurable results that support long-term success.",
        "cards": [
          {
            "number": "01",
            "title": "Data-Driven Planning",
            "description": "Strategic decisions based on comprehensive analysis and market research rather than guesswork."
          },
          {
            "number": "02",
            "title": "Competitive Advantage",
            "description": "Strategic positioning that helps you outrank competitors and capture market share."
          },
          {
            "number": "03",
            "title": "Resource Efficiency",
            "description": "Prioritized action plans that maximize ROI and focus efforts on highest-impact activities."
          },
          {
            "number": "04",
            "title": "Long-Term Growth",
            "description": "Sustainable strategies that build lasting organic visibility and authority in your market."
          }
        ]
      }
    },
  ...
  {
    "id": "section1",
    "title": "How quickly can I see local SEO results?",
    "description": "Local SEO often shows faster results than general SEO. You may see improvements in local rankings and visibility within 4-8 weeks of optimization."
  },
  {
    "id": "section2",
    "title": "Do you manage Google Business Profile?",
    "description": "Yes, Google Business Profile optimization and management is a core component of our local SEO services, including regular updates and customer interaction management."
  },
  {
    "id": "section3",
    "title": "How do you handle online reviews?",
    "description": "We implement review generation strategies, monitor review platforms, and provide response templates and protocols to maintain a positive online reputation."
  },
  {
    "id": "section4",
    "title": "Can you help with multiple business locations?",
    "description": "Absolutely! We specialize in multi-location local SEO with location-specific optimization, consistent NAP management, and individual location performance tracking."
  }
],
      "processSteps": [
        {
      ...
      "whyYourBusinessNeeds": {
        "paragraph": "Local SEO is essential for businesses serving specific geographic areas. Professional local optimization ensures you appear when nearby customers search for your services, driving qualified traffic and increasing local market share through strategic local search visibility.",
        "cards": [
          {
            "number": "01",
            "title": "Local Market Dominance",
            "description": "Achieve top visibility when customers search for services in your local area."
          },
          {
            "number": "02",
            "title": "Increased Foot Traffic",
            "description": "Drive more customers to your physical location through improved local search presence."
          },
          {
            "number": "03",
            "title": "Mobile Search Optimization",
            "description": "Capture mobile users searching for nearby businesses while on the go."
          },
          {
            "number": "04",
            "title": "Community Authority",
            "description": "Build trust and credibility within your local community through consistent online presence."
          }
        ]
      }
    },
  ...
  {
    "id": "section1",
    "title": "What technical issues do you typically find?",
    "description": "Common issues include slow loading speeds, crawling problems, duplicate content, broken links, missing schema markup, and mobile usability problems."
  },
  {
    "id": "section2",
    "title": "How do you improve Core Web Vitals?",
    "description": "We optimize images, minimize code, implement efficient caching, improve server response times, and address layout shift issues to meet Core Web Vitals standards."
  },
  {
    "id": "section3",
    "title": "Do you fix crawling and indexing issues?",
    "description": "Yes, we identify and resolve crawling errors, optimize robots.txt and XML sitemaps, fix redirect chains, and ensure proper URL structure for optimal indexing."
  },
  {
    "id": "section4",
    "title": "Can you implement structured data?",
    "description": "We implement relevant schema markup to help search engines understand your content better and enable rich snippets in search results."
  }
],
      "processSteps": [
        {
      ...
      "whyYourBusinessNeeds": {
        "paragraph": "Technical SEO provides the foundation for all other SEO efforts. Without proper technical optimization, even great content and links cannot achieve their full potential. Professional technical SEO ensures search engines can access, understand, and rank your content effectively.",
        "cards": [
          {
            "number": "01",
            "title": "Search Engine Accessibility",
            "description": "Ensure search engines can efficiently crawl, index, and understand your website content."
          },
          {
            "number": "02",
            "title": "Improved User Experience",
            "description": "Fast-loading, mobile-friendly websites that provide excellent user experiences and reduce bounce rates."
          },
          {
            "number": "03",
            "title": "Competitive Advantage",
            "description": "Technical superiority that helps you outrank competitors with poor technical foundations."
          },
          {
            "number": "04",
            "title": "Future-Proof Foundation",
            "description": "Scalable technical architecture that supports growth and adapts to algorithm changes."
          }
        ]
      }
    },
  ...
  {
    "id": "section1",
    "title": "What pages do you optimize?",
    "description": "We optimize all important pages including homepages, service pages, product pages, blog posts, and landing pages based on their strategic importance and traffic potential."
  },
  {
    "id": "section2",
    "title": "How do you choose target keywords?",
    "description": "We select keywords based on search volume, competition level, user intent, and business relevance to ensure each page targets the most valuable terms."
  },
  {
    "id": "section3",
    "title": "Do you rewrite existing content?",
    "description": "We optimize existing content by improving keyword integration, enhancing readability, adding valuable information, and restructuring for better search performance."
  },
  {
    "id": "section4",
    "title": "How do you optimize for user experience?",
    "description": "We improve page layout, enhance content formatting, optimize call-to-action placement, and ensure content serves user intent while maintaining SEO effectiveness."
  }
],
      "processSteps": [
        {
      ...
      "whyYourBusinessNeeds": {
        "paragraph": "On-page SEO directly impacts how search engines understand and rank your content. Professional optimization ensures each page serves both search engines and users effectively, maximizing visibility while providing value that converts visitors into customers.",
        "cards": [
          {
            "number": "01",
            "title": "Content Relevance",
            "description": "Ensure your content perfectly matches user search intent and provides comprehensive value."
          },
          {
            "number": "02",
            "title": "Improved Rankings",
            "description": "Strategic optimization that helps individual pages rank higher for target keywords."
          },
          {
            "number": "03",
            "title": "Better User Experience",
            "description": "Enhanced page experience that keeps visitors engaged and encourages conversions."
          },
          {
            "number": "04",
            "title": "Increased Click-Through Rates",
            "description": "Compelling meta tags and snippets that attract more clicks from search results."
          }
        ]
      }
    },
  ...
  {
    "id": "section1",
    "title": "What types of backlinks do you build?",
    "description": "We focus on high-quality, relevant backlinks from authoritative websites through guest posting, resource pages, partnerships, and earned media coverage."
  },
  {
    "id": "section2",
    "title": "How do you ensure link quality?",
    "description": "We thoroughly vet all link opportunities, focusing on domain authority, relevance, and natural link context while avoiding low-quality or spammy sources."
  },
  {
    "id": "section3",
    "title": "Do you create content for link building?",
    "description": "Yes, we create valuable, linkable content assets including research studies, industry guides, infographics, and guest posts that naturally attract quality backlinks."
  },
  {
    "id": "section4",
    "title": "How do you measure off-page SEO success?",
    "description": "We track domain authority growth, quality backlink acquisition, brand mention increases, and the impact on search rankings and organic traffic."
  }
],
      "processSteps": [
        {
      ...
      "whyYourBusinessNeeds": {
        "paragraph": "Off-page SEO builds the authority and trust signals that search engines use to determine rankings. Quality backlinks and brand mentions demonstrate credibility and expertise, helping you outrank competitors and establish market leadership in search results.",
        "cards": [
          {
            "number": "01",
            "title": "Domain Authority Growth",
            "description": "Build website authority through high-quality backlinks from trusted, relevant sources."
          },
          {
            "number": "02",
            "title": "Competitive Advantage",
            "description": "Outrank competitors through superior link profiles and brand authority signals."
          },
          {
            "number": "03",
            "title": "Brand Recognition",
            "description": "Increase brand visibility and recognition through strategic content promotion and partnerships."
          },
          {
            "number": "04",
            "title": "Long-Term Value",
            "description": "Build lasting relationships and authority that provide ongoing SEO value and growth."
          }
        ]
      }
    },
      ...
      "faq": [
  {
    ...
    "description": "We optimize product titles, descriptions, images, and URLs while implementing product schema markup and ensuring pages target high-intent commercial keywords."
  },
  {
    "id": "section2",
    "title": "Can you handle large product catalogs?",
    "description": "Yes, we specialize in large-scale e-commerce SEO with automated optimization solutions, bulk editing capabilities, and efficient category structure organization."
  },
  {
    "id": "section3",
    "title": "How do you handle duplicate content?",
    "description": "We implement canonical tags, create unique product descriptions, optimize filtering and navigation, and address manufacturer content duplication issues."
  },
  {
    "id": "section4",
    "title": "Do you optimize for shopping searches?",
    "description": "We target commercial and transactional keywords, optimize for Google Shopping, implement product rich snippets, and focus on high-intent shopping queries."
  }
],
      "processSteps": [
        {
      ...
      "whyYourBusinessNeeds": {
        "paragraph": "E-commerce SEO requires specialized strategies that balance search visibility with conversion optimization. Professional e-commerce SEO drives qualified traffic that converts into sales while building long-term organic growth for sustainable business success.",
        "cards": [
          {
            "number": "01",
            "title": "Increased Online Sales",
            "description": "Drive qualified traffic that converts into sales through targeted e-commerce optimization."
          },
          {
            "number": "02",
            "title": "Product Visibility",
            "description": "Ensure your products appear when customers search for items you sell."
          },
          {
            "number": "03",
            "title": "Competitive Market Share",
            "description": "Outrank competitors and capture more market share in your product categories."
          },
          {
            "number": "04",
            "title": "Long-Term Growth",
            "description": "Build sustainable organic growth that reduces dependence on paid advertising."
          }
        ]
      }
    },
  ...
  {
    "id": "section1",
    "title": "What's included in a content strategy?",
    "description": "Our content strategy includes audience analysis, topic research, content calendar planning, SEO guidelines, workflow setup, and performance tracking systems."
  },
  {
    "id": "section2",
    "title": "How do you identify content topics?",
    "description": "We research trending topics, analyze competitor content, identify keyword opportunities, and align topics with your audience needs and business objectives."
  },
  {
    "id": "section3",
    "title": "Do you create the actual content?",
    "description": "Content strategy focuses on planning and guidelines. We can also provide content creation services or work with your team to implement the strategy effectively."
  },
  {
    "id": "section4",
    "title": "How do you measure content success?",
    "description": "We track content performance through organic traffic, engagement metrics, social shares, conversions, and search ranking improvements for targeted keywords."
  }
],
      "processSteps": [
        {
      ...
      "whyYourBusinessNeeds": {
        "paragraph": "Strategic content planning ensures your content efforts support both SEO goals and business objectives. Professional content strategy maximizes the impact of your content investment while building lasting authority and audience relationships that drive sustainable growth.",
       "cards": [
          {
            "number": "01",
            "title": "Topical Authority",
            "description": "Build recognized expertise in your field through comprehensive, strategic content coverage."
          },
          {
            "number": "02",
            "title": "Audience Engagement",
            "description": "Create content that resonates with your target audience and encourages meaningful interaction."
          },
          {
            "number": "03",
            "title": "Efficient Resource Use",
            "description": "Strategic planning that maximizes content ROI and focuses efforts on highest-impact opportunities."
          },
          {
            "number": "04",
            "title": "Consistent Growth",
            "description": "Sustainable content strategies that build long-term organic visibility and authority."
          }
        ]
      }
    },
  ...
  {
    "id": "section1",
    "title": "How many keywords do you research?",
    "description": "We typically research hundreds to thousands of keywords, then filter and prioritize them based on relevance, competition, and business value to create focused target lists."
  },
  {
    "id": "section2",
    "title": "Do you research competitor keywords?",
    "description": "Yes, competitor keyword analysis is essential to understand market opportunities, identify gaps, and discover keywords your competitors rank for that you don't."
  },
  {
    "id": "section3",
    "title": "How do you determine keyword difficulty?",
    "description": "We analyze search results, domain authority of ranking sites, content quality, and link profiles to assess realistic ranking potential and timeline expectations."
  },
  {
    "id": "section4",
    "title": "Do you provide keyword mapping?",
    "description": "Yes, we map keywords to existing pages and identify new content opportunities, creating strategic plans for implementing keywords across your website."
  }
],
      "processSteps": [
        {
      ...
      "whyYourBusinessNeeds": {
        "paragraph": "Strategic keyword research forms the foundation of successful SEO campaigns. Professional research identifies the most valuable opportunities while avoiding competitive dead ends, ensuring your SEO efforts focus on keywords that drive qualified traffic and business results.",
        "cards": [
          {
            "number": "01",
            "title": "Targeted Traffic",
            "description": "Attract visitors who are actively searching for your products, services, or information."
          },
          {
            "number": "02",
          ...
          },
          {
            ...
            "description": "Guide content creation with data-driven insights about what your audience searches for."
          },
          {
            "number": "04",
            "title": "ROI Optimization",
            "description": "Focus efforts on keywords with the highest potential for business impact and growth."
          }
        ]
      }
    },
  ...
  {
    "id": "section1",
    "title": "What does an SEO audit include?",
    "description": "Our comprehensive audit covers technical SEO, on-page optimization, content analysis, backlink profile review, competitive analysis, and prioritized recommendations."
  },
  {
    "id": "section2",
    "title": "How detailed are the audit findings?",
    "description": "We provide detailed reports with specific issues identified, their impact on SEO performance, and step-by-step recommendations for resolving each problem."
  },
  {
    "id": "section3",
    "title": "Do you provide implementation support?",
    "description": "We provide detailed implementation guidance and can offer ongoing support to help execute audit recommendations effectively and efficiently."
  },
  {
    "id": "section4",
    "title": "How often should I get an SEO audit?",
    "description": "We recommend comprehensive audits annually, with focused technical audits quarterly, especially after major website changes or algorithm updates."
  }
],
      "processSteps": [
        {
      ...
      "whyYourBusinessNeeds": {
        "paragraph": "SEO audits provide the foundation for effective optimization by identifying what's working, what's broken, and what opportunities exist. Professional audits save time and resources by focusing efforts on highest-impact improvements while avoiding common pitfalls.",
        "cards": [
          {
            "number": "01",
            "title": "Issue Identification",
            "description": "Discover hidden technical and content issues that are holding back your search performance."
          },
          {
            "number": "02",
            "title": "Competitive Intelligence",
            "description": "Understand how you compare to competitors and identify opportunities to gain advantages."
          },
          {
            "number": "03",
            "title": "Strategic Roadmap",
            "description": "Get clear, prioritized action plans that focus efforts on highest-impact improvements."
          },
          {
            "number": "04",
            "title": "Performance Baseline",
            "description": "Establish current performance benchmarks to measure future improvement and ROI."
          }
        ]
      }
    }
...
<img
  ...
  alt={`${step.title} illustration`}
  style={{
    marginTop: deviceType === 'desktop' 
      ? `${100 + (index * 20)}px`  // ADD THIS: Dynamic positioning based on step index
      : styles.image.marginTop,
