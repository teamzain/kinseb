    ...
    if (typeof window !== 'undefined' && viewportHeight > 0 && viewportWidth > 0) {
      ...
      return {
        ...
        paginationContainer: {
          ...
          // Fixed mobile gap between card and dots
          margin: viewportWidth < 768 ? '10px auto' : `${Math.max(15, 30 * combinedFactor)}px auto`,
          marginTop: viewportWidth < 768 ? '5px' : '20px', // Reduced gap on mobile
        },
        buttonsContainer: {
