  ...
  const getResponsiveStyles = () => {
    ...
    const styles = {
      ...
      description: {
        ...
        lineHeight: '1.4',
        marginTop: '7px',
        textAlign: 'center' // Center description on mobile
      },
      bulletPoint: {
        fontSize: '0.95rem',
        marginBottom: '10px',
                    ...
                    <div style={{ 
                      ...
                      <div 
                        style={{ 
                          ...
                          textAlign: styles.numberContainer.textAlign as "center" | "left" | "right", // Explicitly typed
                        }}
                      >
                        {/* Number */}
                        <div
                          style={{
                            ...
                            textAlign: styles.number.textAlign as "center" | "left" | "right", // Explicitly typed
                          }}
                          onMouseEnter={handleMouseEnter}
                          onMouseLeave={handleMouseLeave}
                        >
                        ...
                        <h2
                          style={{
                            ...
                            lineHeight: '1.2',
                            textAlign: styles.title.textAlign as "center" | "left" | "right", // Explicitly typed
                          }}
                          onMouseEnter={handleMouseEnter}
                          onMouseLeave={handleMouseLeave}
                        >
                    ...
                    >
                      <p 
                        ...
                        style={{
                          ...
                          textAlign: deviceType === 'mobile' ? 'center' : 'left' // Center text on mobile
                        }}
                      >
                        {step.description}
                      </p>
                        ...
                        {step.bulletPoints.map((point, pointIndex) => (
                          <li
                            ...
                            style={{
                              ...
                              position: 'relative',
                              textAlign: deviceType === 'mobile' ? 'center' : 'left' // Center bullet point text on mobile
                            }}
                          >
                            {point}
                          </li>
        ...
        <style>
          {`
            ...
            .bullet-list {
              ...
              margin-top: 8px; /* Added margin-top to the bullet list */
            }
            
            .bullet-list li {
              margin-left: 0;
              padding-left: 2px; /* Reduced from 5px to tighten space */
              margin-bottom: 6px; /* Added some vertical spacing between items */
            }
            ...
            .mobile-bullets {
              ...
              padding-left: 0;
              text-align: center;
              margin-top: 10px; /* Added margin to mobile bullet list */
            }
            
            .mobile-bullets li {
              padding-left: 0;
              margin-bottom: 8px; /* Added spacing between mobile bullet items */
            }
            
            .mobile-bullets li:before {
              content: "•";
              display: inline-block;
              width: 0.7em; /* Reduced from 1em */
