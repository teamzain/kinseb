  ...
  return (
    <>
      ...
      <div style={{
        ...
        {/* Navigation Tabs - Added more gap after tab line */}
        <div style={{
          position: 'absolute',
          width: '1260px',
          left: '50%',
          top: '244px', // Moved up to create more space below
          transform: 'translateX(-50%)',
          display: 'flex',
          ...
          {tabs.map((tab) => (
            <div 
              ...
              style={{
                position: 'relative',
                width: '242px',
                height: tab.id === activeTab ? '92px' : '70px',
        ...
        <div style={{
          position: 'absolute',
          width: '100%',
          top: '377px', // Increased to create more gap after blue line
          display: 'flex',
          justifyContent: 'space-between',
          padding: '0 89px',
          boxSizing: 'border-box'
