...
export default function BusinessServices() {
  ...
  // Icon and hover image assignments - we'll keep these static
  const iconMapping = [
    "/images/Vector.png",
  ...
  useEffect(() => {
    const fetchSectionData = async () => {
      try {
        ...
        console.error('Exception fetching business section data:', error);
      } finally {
        setIsLoading(false);
      }
    };
  ...
  // Generate services array based on fetched data or fallback to defaults
  const services: ServiceItem[] = sectionData ? [
    {
      iconSrc: iconMapping[0],
      ...
      hoverImage: hoverImageMapping[0],
    },
    {
      iconSrc: iconMapping[1],
      ...
      hoverImage: hoverImageMapping[1],
    },
    {
      iconSrc: iconMapping[2],
      ...
      hoverImage: hoverImageMapping[2],
    },
    {
      iconSrc: iconMapping[3],
      ...
      hoverImage: hoverImageMapping[3],
    },
    {
      iconSrc: iconMapping[4],
      ...
      hoverImage: hoverImageMapping[4],
    },
    {
      iconSrc: iconMapping[5],
      ...
      hoverImage: hoverImageMapping[5],
    },
    {
      iconSrc: iconMapping[6],
      ...
      hoverImage: hoverImageMapping[6],
    },
  ] : defaultServices;
  ...
  const sectionTitle = sectionData?.section_title || "Your Business Is Unique";
    ...
    <div style={containerStyle} ref={sectionRef}>
      <div style={contentStyle}>
        <div style={headerStyle}>
          <h2 style={titleStyle}>
            <span style={{ color: '#36b2c8' }}>
              {sectionTitle.split(' ')[0]}
            </span> {sectionTitle.split(' ').slice(1).join(' ')}
          </h2>
              ...
              <button 
                ...
                style={{
                  ...
                  background: leftButtonHovered
                    ? 'linear-gradient(180deg, rgba(13, 152, 186, 0.5) 0%, rgba(0, 0, 0, 0.5) 100%), #0D98BA'
            ...
            {isMobile ? (
              ...
              services.map((service, index) => (
                <ServiceCard
                  ...
                  animationDelay={100 * (index % 4)} // Staggered animation for visible cards
                  isVisible={isVisible}
                />
              ))
            )}
              ...
              {services.map((_, index) => (
                <div
                  ...
                  style={{
                    ...
                    backgroundColor: currentMobileIndex === index ? '#0D98BA' : '#d1d5db',
                  }}
                />
              ))}
            </div>
