...
const FigmaDesignComponent = () => {
  ...
  const intervalRef = useRef(null); // Reference to store interval
  ...
  const cards = [
    ...
    },
    {
      ...
      backgroundImage: "/images/vision.jpg", // Using placeholder image
    ...
    },
    {
      ...
      backgroundImage: "/images/values.jpg", // Using placeholder image
  ...
  // Separate useEffect for auto-carousel with pause functionality
  useEffect(() => {
    if (!isPaused) {
  ...
  }, [cards.length, isPaused]); // Re-run when isPaused changes
  ...
  // Handle mouse enter and leave for pausing carousel
  ...
  const structuredData = {
    ...
    "@type": "Organization",
    "name": "Kinseb Web Development", // Replace with your actual company name
    ...
    "url": "https://kinsebwebdevelopment.com" // Replace with your website URL
  };
  ...
  return (
    <>
      ...
      >
        ...
        {/* Carousel container with responsive sizing and hover events */}
        <div 
          style={{
        ...
        >
          {/* Carousel with touch events for mobile and preloaded images */}
          <div 
            style={{
              position: 'relative',
              width: '100%',
          ...
          >
            {/* Pre-render all images but only show active card */}
            ...
            {cards.map((card, index) => (
              ...
              >
                {/* Image with proper alt text for accessibility and SEO - Always rendered for active card */}
                <img 
                  src={card.backgroundImage}
                  alt={card.altText}
                  style={{
