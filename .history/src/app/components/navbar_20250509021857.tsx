...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      document.body.style.overflow = '';
      document.documentElement.style.overflow = ''; // Add this line for cleanup
    };
  }, [isMenuOpen, mounted]);
      ...
      <style jsx global>{`
        * {
        ...
        .hamburger-container {
          ...
          justify-content: center;
          cursor: pointer;
          z-index: 1010; /* Increased z-index to appear above overlay */
          margin-left: auto;
          margin-right: 10px;
          background-color: #1A1A1A;
          border-radius: 6px;
        ...
        .overlay {
          ...
          z-index: 999; /* Just below the menu but above other content */
          opacity: 0;
          visibility: hidden;
        ...
        /* Fix for main logo when menu is open */
        body.menu-open .navbar .logo-container {
          opacity: 0;
          visibility: hidden;
          transition: opacity 0.3s ease, visibility 0.3s ease;
        }
        ...
        @media (max-width: 768px) {
          ...
          /* Fix for Quote button on mobile */
          .navbar .container .quote-button {
            display: inline-block !important; /* Force display instead of hiding */
            padding: 0.6rem 1rem;
            font-size: 0.85rem;
            margin-right: 15px;
          }
