...
const Navbar = () => {
  ...
  const toggleServiceSlider = (e: React.MouseEvent<HTMLElement> | React.KeyboardEvent<HTMLElement>) => {
    ...
    // On desktop, keep menu open when service slider opens
  ...
  const closeServiceSlider = () => {
    setIsServiceSliderOpen(false);
    // On desktop, when service slider closes, you can choose to keep menu open or close it
    // Currently keeping menu open for better UX
  };
  ...
  useEffect(() => {
    if (!isMenuOpen) {
      setOpenDropdown(null);
      // Only close service slider on mobile when menu closes
      if (window.innerWidth < 769) {
        setIsServiceSliderOpen(false);
      }
    }
      ...
      <style>{`
        * {
        ...
        .service-slider {
          ...
          width: calc(100vw - 450px); /* Account for menu width + margin */
          height: 100vh;
          ...
          border-radius: 0 15px 15px 0; /* Add subtle border radius */
        }

        .service-slider.open {
          left: 420px; /* Slide to position next to menu with gap */
        }
        ...
        .service-slider-tab {
          ...
          width: 100%;
          border-radius: 12px;
          transition: all 0.6s cubic-bezier(0.16, 1, 0.3, 1); /* Slower transition */
          position: relative;
        ...
        .service-slider-tab::before {
          ...
          border-radius: 12px;
          opacity: 0;
          transition: opacity 0.6s ease; /* Slower transition */
        }
        ...
        .service-slider-link::after {
          ...
          transition: width 0.6s ease; /* Slower transition */
          border-radius: 1px;
        }
        ...
        /* Ensure service slider appears above menu on mobile */
        .service-slider-open .service-slider {
          z-index: 1002;
        }

        /* Desktop: Show overlay only when service slider is open */
        ...
        /* Desktop: Service slider positioning alongside menu */
        @media (min-width: 769px) {
          /* Service slider is positioned behind sidebar */
          .service-slider {
            left: 420px;
          ...
          /* When service slider is open, it slides out from behind */
          .service-slider.open {
            transform: translateX(0);
          }

          /* Ensure both menu and slider can be visible simultaneously */
          .menu-side {
            z-index: 1000; /* Above service slider */
          }

          /* Show menu automatically when service slider is open */
          .service-slider-open .menu-side {
            transform: translateX(-400px);
          }

          /* Prevent menu from closing when service slider is open */
          .service-slider-open .menu-side.open {
            transform: translateX(-400px);
          }
        }
        ...
        @media (max-width: 768px) {
          ...
          /* SERVICE SLIDER MOBILE OPTIMIZATIONS - IMPROVED */
          .service-slider {
            flex-direction: column;
            transition: all 0.8s cubic-bezier(0.16, 1, 0.3, 1); /* Slower on mobile too */
            z-index: 1001;
          ...
          .service-slider.open {
            left: 0; /* Slide to cover full screen on mobile */
          }
          ...
          .service-slider-tab {
            ...
            margin: 0 0.15rem;
            background: linear-gradient(135deg, rgba(255, 255, 255, 0.08) 0%, rgba(0, 188, 212, 0.05) 100%);
            backdrop-filter: blur(10px);
          ...
          .service-slider-tab.active {
            ...
            transform: translateY(-3px);
            background: linear-gradient(135deg, rgba(0, 188, 212, 0.15) 0%, rgba(13, 152, 186, 0.1) 100%);
          ...
          .service-slider-tab.active {
            background: linear-gradient(135deg, rgba(0, 188, 212, 0.25) 0%, rgba(13, 152, 186, 0.15) 100%);
