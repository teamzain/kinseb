        ...
        >
          {cards.map((card, index) => (
            ...
            >
              ...
              {/* Text content container with proper vertical centering */}
              <div 
                style={{
                  position: 'absolute',
                  display: 'flex',
              ...
              >
                {/* Card content container - this is the key container for vertically centered content */}
              ...
              // Find this div in your code - it controls the button container
<div 
  style={{
    display: 'flex',
    flexDirection: 'row',
    ...
    justifyContent: 'flex-start', // This is already correct for left alignment
    opacity: isVisible ? 1 : 0,
    transform: isVisible ? 'translateY(0)' : 'translateY(30px)',
    transition: 'opacity 0.8s ease-out 0.4s, transform 0.8s ease-out 0.4s',
    zIndex: 2,
    position: 'relative', // Add this to ensure proper positioning
    width: 'auto', // Add this to prevent container from expanding to full width
  }}
...
>
  <button 
    style={{
      ...
      alignSelf: 'flex-start', // Add this to ensure the button stays left-aligned
    }}
