    ...
    <div className="landing-container">
      ...
      <style jsx>{`
        ...
        .landing-container {
          position: relative;
          width: 100%;
          min-height: 80vh; /* Reduced from 90vh to 80vh for better fit on laptop */
        ...
        /* Contact Info Styles */
        .contact-info {
          margin-top: 200px; /* Reduced from 300px to 200px */
        }
        ...
        .form-container {
          ...
          height: auto; /* Let the form height be determined by content */
          max-height: 80vh; /* Maximum height for laptop - adjusted */
        ...
        @media (max-width: 1024px) {
          ...
          .contact-info {
            margin-top: 150px; /* Further reduced for better spacing */
          }
        }
        ...
        @media (max-width: 900px) {
          ...
          /* Hide background image on tablets and below */
          .background-image {
            display: none;
          }
          
          /* Adjust contact info margin when image is hidden */
          .contact-info {
            margin-top: 40px;
          }
        }
