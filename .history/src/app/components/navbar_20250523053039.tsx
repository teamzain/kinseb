      ...
      <style>{`
        * {
        ...
        .service-slider {
          ...
          margin-left: -3200px; /* Add right margin for spacing */
        ...
        @media (min-width: 769px) {
          ...
          .service-slider {
            left: 100%;
            width: calc(100vw - 450px); /* Account for menu + margin */
          }

          /* When service slider is open, it appears next to the menu with gap */
          .service-slider.open {
            left: 420px; /* 400px menu + 20px gap */
          }
