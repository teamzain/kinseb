    ...
    <div className="landing-container">
      ...
      <style jsx>{`
        ...
        .landing-container {
          ...
          width: 100%;
          min-height: 100vh;
          background: linear-gradient(180deg, #04091D 0%, #05305E 200%);
          display: flex;
        ...
        .contact-info {
          margin-top: 60px; /* Increased gap before Follow us section */
        }
        ...
        .input-container {
          ...
          display: flex;
          align-items: center;
          padding-left: 42px; /* Add padding to accommodate the icon */
        }
