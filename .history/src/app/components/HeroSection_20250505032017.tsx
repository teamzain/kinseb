...
const HeroSection = () => {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            maxWidth: '42rem',
            margin: isMobile ? '0 auto' : '0 0 0 1rem',
  ...
  <h1 style={{
    ...
    <div style={{ display: 'inline-block' }}>Building </div>
    <div style={{ display: 'inline-block', color: 'rgb(34, 211, 238)' }}>Websites </div>
    <div style={{ display: 'inline-block' }}>That Drive Growth</div>
  </h1>
</div>
            {/* Description text */}
            <p style={{
