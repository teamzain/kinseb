  ...
  return (
    <>
        ...
        <div className="container">
          ...
          >
            ...
            <div className="content-layout">
              ...
              {/* Mobile-only showcase grid - REMOVED */}
              {/* <div className="mobile-showcase">
                <div className="showcase-grid">
                  <div className="showcase-item showcase-item-1">
                    <div className="showcase-image">
                      <img src="/images/89.png" alt="Professional Website Design Example" />
                    </div>
                    <div className="showcase-overlay">
                      <span className="showcase-label">Custom Design</span>
                    </div>
                  </div>
                  <div className="showcase-item showcase-item-2">
                    <div className="showcase-image">
                      <img src="/images/90.png" alt="Responsive Web Development Example" />
                    </div>
                    <div className="showcase-overlay">
                      <span className="showcase-label">Responsive Layout</span>
                    </div>
                  </div>
                </div>
              </div> */}
      ...
      <style jsx>{`
        ...
        /* Mobile Showcase - REMOVED */
        .mobile-showcase {
          display: none;
        }

        /* Animate showcase items when visible */
        @media (max-width: 768px) {
          .main-card.visible .showcase-item-1 {
            animation: slideUpFade 0.8s ease forwards;
            animation-delay: 0.8s;
          }
          
          .main-card.visible .showcase-item-2 {
            animation: slideUpFade 0.8s ease forwards;
