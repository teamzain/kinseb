    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          padding: isMobile ? '15px 15px 30px' : '0', // Increased bottom padding for mobile
          opacity: isVisible ? 1 : 0,
        ...
        <div style={{
          ...
          alignItems: 'center',
          textAlign: isMobile ? 'left' : 'center',
          marginTop: isMobile ? '-25px' : '1.25px', // Increased negative margin to create better overlap in mobile
        ...
        <div style={{
          ...
          alignItems: 'center',
          textAlign: isMobile ? 'left' : 'center',
          marginTop: isMobile ? '-25px' : '20px', // Increased negative margin to create better overlap in mobile
          marginLeft: isMobile ? '0' : '-20px',
          padding: isMobile ? '15px 15px 25px' : '0', // Added bottom padding for mobile
          opacity: isVisible ? 1 : 0,
          transform: isVisible ? 'translateY(0)' : 'translateY(50px)',
