                  ...
                  <h3 style={styles.heading}>
                    {card.heading.split('\n').map((line, i) => (
                      <React.Fragment key={i}>
                        ...
                        {i === card.heading.split('\n').length - 1 && 
                          <span style={styles.solutions}>{line.includes('Solutions') ? ' Solutions' : 
...
const styles = {
  ...
  textContainer: {
    position: 'relative',
    width: '535px',
    margin: '160px 0 0 75px', // Increased top margin from 120px to 160px to move content downward
  },
  h2: {
    position: 'absolute',
    width: '782px',
  ...
  heading: {
    ...
    color: '#FFFFFF',
    marginBottom: '30px',
    marginTop: '84px', // Increased from 64px to 84px for more space
  },
  solutions: {
    color: '#0D98BA',
  },
