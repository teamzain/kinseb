  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        marginBottom: '20px',
        zIndex: 1,
        opacity: isHovered ? 0 : 1, // Hide icon on hover
      ...
      <h3 style={{
        ...
        position: 'relative',
        zIndex: 1,
        opacity: isHovered ? 0 : 1, // Hide title on hover
        transition: 'opacity 0.3s ease',
      }}>
        {title}
      </h3>
      ...
      <p style={{
        ...
        position: 'relative',
        zIndex: 1,
        opacity: isHovered ? 0 : 1, // Hide description on hover
        transition: 'opacity 0.3s ease',
      }}>
        {description}
      </p>
      ...
      <div style={{
        ...
        zIndex: 1,
        fontFamily: 'Arial',
        opacity: isHovered ? 0 : 1, // Hide arrow on hover
        transition: 'opacity 0.3s ease',
      }}>
        →
      </div>
