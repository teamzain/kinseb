    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          padding: isMobile ? '15px 15px 40px' : '0', // Increased bottom padding for WordPress in mobile view
          opacity: isVisible ? 1 : 0,
          ...
          {isMobile && (
            <div style={{
              width: '5px',
              height: '160%', // Increased height for better visibility and connection
              position: 'absolute',
              left: '15px', // Aligning with the left padding
              top: '0',
          ...
          <div style={{
            ...
            marginLeft: isMobile ? '35px' : '0', // Added margin to offset content from line
          }}>
            <div style={{
              width: isMobile ? '80px' : '100px',
              height: isMobile ? '80px' : '100px',
              marginBottom: isMobile ? '0' : '20px',
              marginBottom: isMobile ? '15px' : '0', // Added bottom margin to increase space between cards
              display: 'flex',
              justifyContent: 'center',
              alignItems: 'center',
            }}>
        ...
        <div style={{
          ...
          alignItems: 'center',
          textAlign: isMobile ? 'left' : 'center',
          marginTop: isMobile ? '-30px' : '1.25px', // Increased negative margin for better connection
          marginLeft: isMobile ? '0' : '-20px',
          padding: isMobile ? '15px 15px 40px' : '0', // Increased bottom padding for Shopify in mobile view
          opacity: isVisible ? 1 : 0,
          transform: isVisible ? 'translateY(0)' : 'translateY(50px)',
          ...
          {isMobile && (
            <div style={{
              width: '5px',
              height: '140%', // Increased height even more
              position: 'absolute',
              left: '150px', // Aligning with the left padding
              top: '0',
              ...
              <>
                ...
                <div style={{
                  ...
                  <p style={{
                    ...
                    Scalable, user-friendly Shopify stores built for 
                  </p>
                  <p style={{
                    fontSize: '13px',
                    lineHeight: '1.5',
                    ...
                    seamless eCommerce experiences.
                  </p>
                </div>
              </>
            )}
        ...
        <div style={{
          ...
          alignItems: 'center',
          textAlign: isMobile ? 'left' : 'center',
          marginTop: isMobile ? '-30px' : '20px', // Increased negative margin for better connection
          marginLeft: isMobile ? '0' : '-20px',
          padding: isMobile ? '15px 15px 40px' : '0', // Increased bottom padding for Magento in mobile view
          opacity: isVisible ? 1 : 0,
          transform: isVisible ? 'translateY(0)' : 'translateY(50px)',
              ...
              <>
                ...
                <div style={{
                  ...
                  <p style={{
                    ...
                    Powerful Magento solutions designed for 
                  </p>
                  <p style={{
                    fontSize: '13px',
                    lineHeight: '1.5',
        ...
        <div style={{
          ...
          marginTop: isMobile ? '-30px' : '1.25px', // Increased negative margin for better connection
          marginLeft: isMobile ? '0' : '-20px',
          padding: isMobile ? '15px 15px 25px' : '0', // Added bottom padding for mobile
          opacity: isVisible ? 1 : 0,
          transform: isVisible ? 'translateY(0)' : 'translateY(50px)',
              ...
              <>
                ...
                <div style={{
                  ...
                  <p style={{
                    ...
                    Fully custom-built websites crafted from 
                  </p>
                  <p style={{
                    fontSize: '13px',
                    lineHeight: '1.5',
                    ...
                    scratch to meet unique business needs.
                  </p>
                </div>
              </>
            )}
