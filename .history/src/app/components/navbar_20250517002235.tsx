...
const Navbar = () => {
  ...
  // New state for desktop services dialog
  const [showServicesDialog, setShowServicesDialog] = useState(false);
  
  // Ref for the dialog and services button to detect outside clicks
  ...
  // Handle clicks outside the services dialog to close it
  useEffect(() => {
...
.dropdown-toggle.active svg path {
  stroke: #00BCD4;
       ...
       .menu-link-with-dropdown.active {
        ...
        .services-dialog-container.show {
          display: block;
        }
        
        .services-dialog-container.show .services-dialog {
          opacity: 1;
        ...
        /* Desktop services button styles */
        ...
        .desktop-services-button.active {
          color: #00BCD4;
        }
        ...
        @media (max-width: 992px) {
          ...
          /* Hide services dialog on tablet and mobile */
          .services-dialog-container {
