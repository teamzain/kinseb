...
const testimonials: Testimonial[] = [
  ...
  // Disable horizontal scrolling immediately and all scrolling after page load
  useEffect(() => {
    const disableHorizontalScroll = () => {
      // Apply styles to prevent horizontal scrolling only (during loading)
    ...
    const disableAllScrolling = () => {
      // Disable all scrolling after page loads
    ...
    // Apply horizontal scroll prevention immediately when component mounts
    ...
    // Disable all scrolling after all resources are loaded
    const handleLoad = () => {
      setTimeout(() => {
        disableAllScrolling();
      }, 100);
    ...
    // Add event listeners for different loading stages
    ...
    if (document.readyState !== 'complete') {
      ...
      // If already loaded, disable all scrolling immediately
      setTimeout(() => {
        disableAllScrolling();
      }, 100);
    }

    // Also handle resize events to maintain the constraint
    const handleResize = () => {
      disableAllScrolling();
    };
  ...
  return (
    <>
      {/* Immediate script to prevent horizontal scrolling */}
      <script dangerouslySetInnerHTML={{
        __html: `
          (function() {
            const preventHorizontalScroll = function() {
              document.documentElement.style.overflowX = 'hidden';
              document.documentElement.style.overflowY = 'auto';
              document.body.style.overflowX = 'hidden';
              document.body.style.overflowY = 'auto';
            ...
            const disableAllScrolling = function() {
              document.documentElement.style.overflow = 'hidden';
              document.body.style.overflow = 'hidden';
              document.documentElement.style.maxWidth = '100vw';
              document.body.style.maxWidth = '100vw';
            ...
            // Apply horizontal scroll prevention immediately
            ...
            // Disable all scrolling after page is fully loaded
            window.addEventListener('load', function() {
              setTimeout(disableAllScrolling, 100);
            });
            
            // Apply on resize
            window.addEventListener('resize', disableAllScrolling);
          })();
        `
      }} />
      ...
      <style jsx>{`
        ...
        /* After page loads, this will be overridden by JavaScript */
