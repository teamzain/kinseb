...
const FigmaDesignComponent = () => {
  ...
  const getResponsiveStyles = () => {
    ...
    if (typeof window !== 'undefined' && viewportHeight > 0 && viewportWidth > 0) {
      ...
      // This helps prevent bottom cutoff at specific screen sizes
      const containerAspectRatio = viewportWidth >= 980 && viewportWidth < 1100 && viewportHeight < 700 ? 
        '2 / 1' : // Wider aspect ratio for problematic 980x669 size range
        '1.8 / 1'; // Standard aspect ratio for other sizes
      ...
      return {
        ...
        carousel: {
          ...styles.carousel,
          height: 'auto',
          maxHeight: viewportHeight * 0.85, // Match container max height
        },
        container: {
          ...styles.container,
          height: 'auto',
          minHeight: viewportWidth < 768 ? '420px' : '400px',
          maxHeight: viewportHeight * 0.85, // Ensure it doesn't exceed 85% of viewport height
