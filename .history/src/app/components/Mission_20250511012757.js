  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        margin: '0 auto 20px',
        gap: isMobile || isTablet ? '0' : '0', // Removed gap for equal division
        position: 'relative',
      }}>
        {/* WordPress */}
        <div 
        ...
        >
          ...
          {/* Shopify Button (visible on hover for desktop, always visible on mobile/tablet) */}
          {(isMobile || isTablet || (!isMobile && !isTablet && hoveredSection === 'shopify')) && (
            <div style={{ 
              ...
              <SectionButton title="Shopify" color="#95d600" section="shopify" />
            </div>
          )}
        </div>
        
        {/* Point of Sale (Previously Magento) */}
        <div 
          style={{
            flex: '1',
            minWidth: isMobile ? '100%' : isTablet ? '50%' : '25%', // Tablet shows 2 services per row
            ...
            opacity: isVisible ? 1 : 0,
            transform: isVisible ? 'translateY(0)' : 'translateY(50px)',
            transition: 'opacity 0.8s ease-out 0.6s, transform 0.8s ease-out 0.6s, background-color 0.3s ease',
            position: 'relative',
            backgroundColor: !isMobile && !isTablet && hoveredSection === 'pos' || 
        ...
        >
          ...
          {/* Point Of Sale Button (visible on hover for desktop, always visible on mobile/tablet) */}
        ...
        <div 
          style={{
            ...
            alignItems: 'center',
            textAlign: isMobile ? 'left' : 'center',
            marginTop: isMobile ? '0px' : isTablet ? '30px' : '1.25px',
            marginLeft: isMobile ? '0' : '0', // Removed negative margin
            padding: isMobile ? '35px 15px 90px' : isTablet ? '20px 10px 120px' : '20px 0 60px',
            opacity: isVisible ? 1 : 0,
            transform: isVisible ? 'translateY(0)' : 'translateY(50px)',
            ...
            (isTablet && activeSection === 'custom') ? 
              'rgba(97, 218, 251, 0.15)' : 'transparent',
          }}
        ...
        >
          ...
          {/* Custom Button (visible on hover for desktop, always visible on mobile/tablet) */}
          {(isMobile || isTablet || (!isMobile && !isTablet && hoveredSection === 'custom')) && (
            <div style={{ 
              ...
              <SectionButton title="Custom" color="#61dafb" section="custom" />
            </div>
          )}
        </div>
      </div>
