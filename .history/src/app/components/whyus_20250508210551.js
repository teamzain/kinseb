...
const KinsebWebDevelopment = () => {
  ...
  // Function to render cards with animations
  const renderCards = () => {
    return cards.map((card, index) => (
      <div 
        ...
        style={{
          ...
          transform: isVisible 
            ? (activeCardIndex === index ? 'scale(1) translateY(0)' : 'scale(0.95) translateY(0)')
            : 'translateY(40px)',
    ...
    <>
      ...
      >
        ...
        <div style={{
          ...
          <span style={{ fontSize: '20px' }} className="bounce-animation">↓</span>
        </div>
