...
const closeServiceSlider = () => {
  ...
  /* ========== SERVICE SLIDER STYLES - IMPROVED & RESPONSIVE ========== */
        .service-slider {
          ...
          z-index: 998; /* Behind the sidebar menu (menu is z-index 1000) */
          transition: all 1.2s cubic-bezier(0.23, 1, 0.32, 1); /* Slower, smoother animation */
          overflow: hidden;
          display: flex;
        ...
        .service-slider.open {
          left: calc(100% - 500px - 400px); /* Slide from behind menu - 500px slider width - 400px menu width */
        }
        ...
        @media (min-width: 769px) {
          ...
          .service-slider {
            left: 100%;
            width: calc(100vw - 390px); /* Account for menu + margin */
          }

          /* When service slider is open, it appears next to the menu with gap */
          .service-slider.open {
            left: 0px; /* 400px menu + 20px gap */
          }

          /* Ensure menu stays in place when service slider opens */
 .menu-side {
    z-index: 1001; /* Higher than service slider */
  }

  .service-slider {
    z-index: 999; /* Behind the menu */
    transition: all 0.8s cubic-bezier(0.25, 0.46, 0.45, 0.94); /* Smoother animation */
  }
        }
    ...
    width: 40px;
    height: 40px;
    z-index: 9999; /* Ensure it's clickable on mobile */
 ...
 <div 
  ...
  onClick={() => setIsServiceSliderOpen(false)}
