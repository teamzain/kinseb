...
const HeroSection = () => {
  ...
  const videoSource = isMobile ? "/video.mp4" : "/video.mp4";
  ...
  return (
    <div className="relative w-full h-[85vh] overflow-hidden bg-black">
      ...
      <video 
        ref={videoRef}
        className={`absolute top-0 left-0 w-full h-full object-cover opacity-90 z-0 ${videoLoaded ? 'opacity-90' : 'opacity-0'}`}
        autoPlay
        loop
        muted
        playsInline
