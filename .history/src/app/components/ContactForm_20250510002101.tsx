    ...
    <section ref={sectionRef} style={styles.frame}>
      ...
      <div style={{
        ...
        <div style={styles.formRow}>
          <div style={styles.inputContainer}>
            <div style={styles.iconContainer}>
              <img src="/images/.svg" alt="User Icon" style={styles.inputIcon} />
            </div>
          ...
          <div style={styles.inputContainer}>
            <div style={styles.iconContainer}>
              <img src="/images/.svg" alt="Email Icon" style={styles.inputIcon} />
            </div>
        ...
        <div style={styles.formRow}>
          <div style={styles.inputContainer}>
            <div style={styles.iconContainer}>
              <img src="/images/.svg" alt="Company Icon" style={styles.inputIcon} />
            </div>
