...
export default function LandingPage() {
  ...
  return (
    <div style={{
      position: 'relative',
      width: '100%',
      minHeight: '100vh', // Changed from fixed 828px to 100vh
      ...
      boxSizing: 'border-box', // Added to include padding in element's size
    }}>
      {/* Left side content */}
      <div style={{
        maxWidth: '650px',
        ...
        {/* Features */}
        <div style={{ marginBottom: '30px' }}> {/* Reduced margin */}
          <div style={{
            display: 'flex',
            alignItems: 'center',
            marginBottom: '15px',
        ...
        {/* Contact Info */}
        <div style={{ marginTop: '40px' }}> {/* Reduced margin */}
          <h2 style={{
            fontStyle: 'normal',
            fontWeight: 600,
            fontSize: '30px',
            lineHeight: '48px', // Reduced line height
      ...
      <div style={{
        ...
        <h2 style={{
          ...
          fontWeight: 600,
          fontSize: '45px',
          lineHeight: '60px', // Reduced line height
          color: '#FFFFFF',
          margin: '0 0 20px 0',
