...
const TrustSection: React.FC<TrustSectionProps> = ({ 
  ...
  const containerStyles = useMemo(() => ({
    minHeight: isSmallMobile ? '1000px' : isMobile ? '1100px' : '800px',
            ...
            >
              ...
              <motion.div
                ...
                style={{
                  ...
                  cursor: 'pointer',
                  height: isSmallMobile ? '220px' : isMobile ? '250px' : isTablet ? '380px' : '420px',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  backgroundColor: 'rgba(13, 152, 186, 0.05)'
                }}
