  ...
  const footerColumns: FooterColumn[] = [
    {
      ...
      links: [
        ...
        { href: "/careers", label: "Careers", description: "Join our growing team of professionals" },
      ]
    },
    {
      title: "Product",
    ...
    },
    {
      ...
      links: [
        ...
        { href: "/return-policy", label: "Return Policy", description: "Learn about our return policy" },
      ]
    },
  ];
    ...
    <>
      <style jsx global>{`
        ...
        .newsletter-button:hover {
          background: linear-gradient(180deg, rgba(13, 152, 186, 0.5) 0%, rgba(0, 0, 0, 0.5) 100%), #16161E;
        }
        .consent-checkbox {
          display: flex;
