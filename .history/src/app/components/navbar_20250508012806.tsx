...
{ href: "/", label: "Home", id: "home", icon: "/icons/home.svg" },
{ href: "/services", label: "Services", id: "services", icon: "/icons/service.svg" },
{ href: "/portfolio", label: "Portfolio", id: "portfolio", icon: "/icons/portfolio.svg" },
{ href: "/about", label: "About", id: "about", icon: "/icons/about.svg" },
{ href: "/contact", label: "Contact", id: "contact", icon: "/icons/contact.svg" }
];
