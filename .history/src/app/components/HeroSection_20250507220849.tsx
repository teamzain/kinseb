  ...
  return (
    <>
      ...
      <div style={{
        ...
        overflow: 'hidden',
        height: '60vh', // Reduced height for laptops (was 100vh)
        width: '100%',
        maxWidth: '100%',
        ...
        <style jsx global>{`
          ...
          /* Mobile view with two lines and half-shown right column */
          @media (max-width: 480px) {
            ...
            .column-3 {
              left: 75% !important; /* Position to show only half */
              width: 50% !important; /* Make wider so half is still visible */
              z-index: 3;
            }
          }
        `}</style>
