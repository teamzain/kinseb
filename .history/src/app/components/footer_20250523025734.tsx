...
const Footer = () => {
  ...
  const footerColumns: FooterColumn[] = [
    ...
    },
    {
      title: "Services",
      links: [
        { href: "/services", label: "Digital Marketing Services", description: "Boost your online presence with our digital marketing expertise" },
        { href: "/services", label: "Content Writing", description: "Professional content creation services" },
        { href: "/services", label: "SEO for Business", description: "Improve your search engine rankings" },
        { href: "/services", label: "UI Design", description: "Create beautiful and functional user interfaces" },
      ]
    },
    {
      title: "Legal",
