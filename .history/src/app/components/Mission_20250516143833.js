...
const poppins = Poppins({
  ...
  subsets: ['latin'],
  display: 'swap',
  variable: '--font-poppins', // Added variable for consistent usage
});
...
const lato = Lato({
  ...
  subsets: ['latin'],
  display: 'swap',
  variable: '--font-lato', // Added variable for consistent usage
});

// SEO metadata - Added for better SEO
const SEO_DATA = {
  title: "What Drives Us | Our Mission, Vision & Values",
  description: "Discover what drives us to craft clean digital solutions. Our mission is to design purpose-built websites that empower brands to grow and lead in the digital world.",
  keywords: "mission, vision, values, digital solutions, website design, web development",
  ...
  const cards = [
    {
      ...
      linkUrl: "/our-mission", // Added link URL for navigation
    },
    {
      title: "Vision",
      ...
      linkUrl: "/our-vision", // Added link URL for navigation
    },
    {
      title: "Values",
      ...
      backgroundImage: "/api/placeholder/1302/520", // Using placeholder image
      linkUrl: "/our-values", // Added link URL for navigation
    }
  ];
  ...
  return (
    <>
      ...
      <div 
        ...
        className={`scroll-reveal-section ${poppins.variable} ${lato.variable}`}
        aria-label="Our mission, vision, and values carousel"
        role="region"
        itemScope
      ...
      >
        ...
        >
              ...
              >
                ...
                >
                  ...
                  <div className="card-content" style={{
                    ...
                    {/* Button container with Link navigation */}
                    <div 
                      style={{
                        display: 'flex',
                        flexDirection: 'row',
                    ...
                    >
                      {/* Button with Next.js Link component for navigation */}
                      <Link href="/start-project" passHref style={{ display: 'contents', textDecoration: 'none' }}>
                        <button 
                          style={{
          ...
          {/* Pagination dots with responsive sizing and ARIA labels for accessibility */}
          <div 
            style={{
              position: 'absolute',
              display: 'flex',
        ...
        {/* CSS Styles with Animations and Accessibility Improvements */}
        <style jsx global>{`
          @keyframes fadeInUp {
            from {
              opacity: 0;
