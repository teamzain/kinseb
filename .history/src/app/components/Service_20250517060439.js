...
const WebDevelopmentComponent = () => {
  ...
  // Create services array with data from Supabase or fallback to defaults
  const services = [
    {
      key: 'wordpress',
      name: contentData?.card1_title || defaultServices[0].name,
      description: contentData?.card1_description || defaultServices[0].description,
      imagePath: '/images/Wordpress.png',
      color: '#3B7BCE',
      isOdd: true
    },
    {
      key: 'shopify',
      name: contentData?.card2_title || defaultServices[1].name,
      description: contentData?.card2_description || defaultServices[1].description,
      imagePath: '/images/shopify.png',
      color: '#95BF47',
      isOdd: false
    },
    {
      key: 'pos',
      name: contentData?.card3_title || defaultServices[2].name,
      description: contentData?.card3_description || defaultServices[2].description,
      imagePath: '/images/Magento.png',
      color: '#F26322',
      isOdd: true
    },
    {
      key: 'custom',
      name: contentData?.card4_title || defaultServices[3].name,
      description: contentData?.card4_description || defaultServices[3].description,
      imagePath: '/images/icon.png',
      color: '#A66DD4',
      isOdd: false
    }
  ...
  if (loading) {
    return (
      <div style={{...containerStyle, minHeight: '500px', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
      ...
      <div style={containerStyle}>
        ...
        <div style={headerStyle}>
          <h1 style={{
            ...
            {contentData?.section1_heading || "Web Development"}
          </h1>
          <h2 style={{
            ...subtitleStyle,
            textAlign: isMobile ? 'left' : 'center',
          }}>
            {contentData?.section2_heading || 'Tailored For '}<span style={{ color: '#3B7BCE' }}>Clients</span> Needs
          </h2>
          <p style={{
            ...descriptionStyle,
            textAlign: isMobile ? 'left' : 'center',
            ...
            {contentData?.section_description || 'From popular platforms to custom builds — we develop solutions that fit your business perfectly.'}
          </p>
        </div>
