...
{ href: "/services", label: "Services", id: "services", icon: "/images/services-icon.svg" },
{ href: "/portfolio", label: "Portfolio", id: "portfolio", icon: "/images/portfolio-icon.svg" },
{ href: "/about", label: "About", id: "about", icon: "/images/about-icon.svg" },
{ href: "/contact", label: "Contact", id: "contact", icon: "/images/contact-icon.svg" }
];

// Social media links
const socialLinks = [
{ href: "https://twitter.com", icon: "/images/twitter-icon.svg", label: "Twitter" },
{ href: "https://facebook.com", icon: "/images/facebook-icon.svg", label: "Facebook" },
{ href: "https://instagram.com", icon: "/images/instagram-icon.svg", label: "Instagram" },
{ href: "https://linkedin.com", icon: "/images/linkedin-icon.svg", label: "LinkedIn" }
];
...
/* Menu panel - Updated with responsive behavior */
.menu-side {
  position: fixed;
  top: 0;
  right: -340px;
...
/* Newsletter section - styled like the image */
.menu-newsletter {
  margin-top: 2.5rem;
...
.menu-newsletter-input {
  flex: 1;
  background-color: rgba(11, 14, 43, 0.9);
...
.menu-newsletter-input:focus {
  outline: none;
  background-color: rgba(11, 14, 43, 1);
...
@media (max-width: 768px) {
  ...
  /* Make cross button visible on mobile */
  .menu-close {
    position: static;
    margin-left: 10px;
    z-index: 1010;
  ...
  /* Hide main logo when menu is open on mobile */
      ...
      <li className="menu-item" key={link.id}>
        ...
        >
          <span className="menu-link-icon">
            <Image
              src={link.icon || "/images/default-icon.svg"}
              alt=""
              width={20}
              height={20}
            />
