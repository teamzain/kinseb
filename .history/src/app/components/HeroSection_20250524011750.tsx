    ...
    <>
      <Head>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "sameAs": [
              "https://www.linkedin.com/company/kinsebwebdevelopment",
              "https://www.twitter.com/kinsebwebdevelopment",
              "https://www.facebook.com/kinsebwebdevelopment"
            ]
          })}
        </script>
      </Head>
      ...
      <div 
        ...
        style={{
          ...
          overflow: 'hidden',
          height: '95vh', // Default height for desktop
          width: '100%',
          maxWidth: '100%',
      ...
      >
        ...
        <style jsx global>{`
          ...
          /* Responsive Heights for Hero Container */
          ...
          /* Responsive adjustments for Tablet Portrait and below */
