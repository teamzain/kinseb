  ...
  const getResponsiveStyles = () => {
    ...
    const styles = {
      ...
      numberContainer: {
        paddingTop: '0',
        width: '100%',
        textAlign: 'center' // Center the section headings
      },
      number: {
        fontSize: '3rem',
        marginBottom: '4px',
        textAlign: 'center' // Center the section numbers
      },
      title: {
        fontSize: '1.4rem',
        minHeight: '2rem',
                    ...
                    >
                      <p 
                        ...
                        style={{
                          ...
                          marginTop: styles.description.marginTop // Added margin-top
                        }}
                      >
                        {step.description}
                      </p>
                        ...
                        {step.bulletPoints.map((point, pointIndex) => (
                          <li
                            ...
                            style={{
                              ...
                              paddingLeft: styles.bulletPoint.paddingLeft, // Reduced padding
                              position: 'relative'
                            }}
                          >
                            {point}
