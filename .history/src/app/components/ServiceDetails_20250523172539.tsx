...
// import { ServiceData, getServiceById } from './serviceData';
...
// // Explicitly define that serviceId can be a string
...
//         const serviceData = await getServiceById(numericId);
//         if (serviceData) {
