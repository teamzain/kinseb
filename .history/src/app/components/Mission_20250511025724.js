...
const WebDevelopmentComponent = () => {
  ...
  const styles = {
    ...
    // Continuous lines across sections
    continuousLine1: {
      position: 'absolute',
      width: '100%',
      height: '0px',
      left: '0',
      top: '300px', // Position this approximately in the middle of the sections
    ...
    continuousLine2: {
      ...
      height: '0px',
      left: '0',
      top: '600px', // Position this below for the second set of sections
    ...
    sectionsContainer: {
      ...
      margin: '0 auto 20px',
      position: 'relative',
      padding: '40px 0', // Add padding to create space around the sections
    },
    ...
    section: (section, index) => ({
      ...
      marginTop: index < 2 ? 0 : '100px', // Add space between the top and bottom rows
    }),
    ...
    // Horizontal bar for desktop - modified to not include the line itself
    horizontalBar: (color) => ({
      width: '100%',
      height: '5px',
      backgroundColor: 'transparent', // Transparent so we don't see duplicated lines
      margin: '0 0 15px',
      position: 'relative',
      overflow: 'hidden',
