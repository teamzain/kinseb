  ...
  return (
    <>
      ...
      <div style={{
        ...
        >
          {isMobile ? (
            // Mobile: Combined heading in one line
            <h2 className={poppins.className} style={{
              ...
              Why Clients <span style={{ color: '#0D98BA' }}>Trust</span> Kinseb Web Development
            </h2>
          ) : (
            ...
            <>
              <h2 className={poppins.className} style={{
                fontStyle: 'normal',
                fontWeight: '600',
                fontSize: isTablet ? '40px' : '48px',
                lineHeight: isTablet ? '48px' : '56px',
                letterSpacing: '-0.03em',
                color: '#FFFFFF',
                margin: '0',
              }}>
