      ...
      <div style={{
        ...
        <motion.div 
          ...
          style={{
            position: 'absolute',
            width: '699px',
            left: '30%', // Adjusted as per your new code
            top: '50px', // Moved up to fit in viewport
        ...
        >
          <h2 style={{
            ...
            fontStyle: 'normal',
            fontWeight: '600',
            fontSize: '52px', // Keeping your adjusted font size
            lineHeight: '60px',
          ...
          <h2 style={{
            ...
            fontStyle: 'normal',
            fontWeight: '600',
            fontSize: '50px', // Keeping your adjusted font size
            lineHeight: '60px',
            letterSpacing: '-0.03em',
            color: '#FFFFFF',
            marginBottom: '40px', // Added bottom margin for spacing
            margin: '0',
          }}>
        ...
        {/* Navigation Tabs - Adjusted position */}
        <div style={{
          position: 'absolute',
          width: '1260px',
          left: '50%',
          top: '200px', // Moved up further
          transform: 'translateX(-50%)',
          display: 'flex',
          ...
          {tabs.map((tab) => (
            <div 
              ...
              style={{
                position: 'relative',
                width: '242px',
                height: tab.id === activeTab ? '80px' : '65px', // Slightly smaller for above fold
                background: tab.id === activeTab ? 'rgba(13, 152, 186, 0.15)' : 'transparent',
            ...
            >
              {/* Add arrow to active tab - positioned as in your example */}
              {tab.id === activeTab && (
                <div style={{
                  position: 'absolute',
                  left: '40%', // Matching your example position
                  top: '65%',
                  bottom: '5%',
                }}>
              ...
              <h3 style={{
                fontFamily: 'Poppins, sans-serif',
                fontWeight: '500',
                fontSize: '22px', // Slightly smaller for above fold
                lineHeight: '30px',
                textAlign: 'center',
                letterSpacing: '-0.03em',
