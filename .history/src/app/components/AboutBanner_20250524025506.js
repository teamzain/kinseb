...
const Banner = () => {
  ...
  const subtitleStyles = useMemo(() => ({
    ...
    lineHeight: isSmallMobile ? '24px' : isMobile ? '26px' : isTablet ? '28px' : '2px',
    marginTop: isSmallMobile ? '30px' : isMobile ? '35px' : isTablet ? '40px' : '-75px', // Added margin-top for subtitle
    textAlign: 'center',
    color: COLORS.primary,
