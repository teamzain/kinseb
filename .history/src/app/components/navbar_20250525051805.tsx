  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://www.kinsebwebdevelopment.com" />
        ...
        />
        <meta property="og:url" content="https://www.kinsebwebdevelopment.com" />
        <meta property="og:image" content="https://www.kinsebwebdevelopment.com/og-image.jpg" />
        ...
        <meta 
          ...
          content="Professional web development and digital services to elevate your online presence." 
        />
        <meta name="twitter:image" content="https://www.kinsebwebdevelopment.com/twitter-image.jpg" />
        ...
        {JSON.stringify({
          ...
          "potentialAction": {
            "@type": "SearchAction",
            "target": "https://www.kinsebwebdevelopment.com/search?q={search_term_string}",
   ...
   .navbar * {
        ...
        /* ========== SERVICE SLIDER STYLES - SPLIT SCREEN EFFECT ========== */
        .service-slider {
          position: fixed;
          top: 0; /* Same as sidebar - starts from very top */
          left: 0; /* Start from left edge of screen */
          width: 100vw; /* Full width initially */
          height: 100vh; /* Same height as sidebar - full viewport height */
          background: linear-gradient(135deg, #050922 0%, #0a1240 100%);
          z-index: 900; /* Behind sidebar (which is z-index: 1000) */
        ...
        .service-slider-item {
          ...
          border-radius: 12px;
          padding: 1.2rem 1.5rem; /* Reduced top/bottom padding from 1.5rem to 1.2rem */
          transition: all 0.4s cubic-bezier(0.16, 1, 0.3, 1);
        ...
        /* Hide overlay when service slider is open */
        .service-slider-open .overlay {
          opacity: 0 !important;
        ...
        /* Desktop-specific service slider behavior - SPLIT SCREEN EFFECT */
        @media (min-width: 769px) {
          /* Service slider positioning for desktop split-screen */
          .service-slider {
            opacity: 0;
            visibility: hidden;
            pointer-events: none;
            transition: all 0.8s cubic-bezier(0.16, 1, 0.3, 1);
            top: 0; /* Same as sidebar - full height */
            left: 0;
            width: 100vw;
            height: 100vh; /* Match sidebar height exactly */
            z-index: 900; /* Behind sidebar */
          }

          /* When menu is open, prepare service slider space */
          .menu-open .service-slider {
            opacity: 1;
            visibility: visible;
            pointer-events: all;
            /* Add padding-right to create space for the sidebar */
            padding-right: 400px; /* Same as sidebar width */
          }

          /* When service slider is also open, slide it in */
          .menu-open .service-slider.open {
            transform: translateX(0);
          }

          /* Adjust service slider content to fill available space */
          .menu-open .service-slider .service-slider-tabs,
          .menu-open .service-slider .service-slider-content {
            margin-right: 0; /* Reset any margins */
          }

          /* Ensure sidebar stays on top */
          .menu-side {
            z-index: 1000; /* Above service slider */
          }
      ...
      <nav className="navbar" role="navigation" aria-label="Main Navigation">
        ...
        >
          ...
          <div className="service-slider-tabs">
            <button 
              className={`service-slider-tab ${activeServiceTab === 'design' ? 'active' : ''}`}
              onClick={() => changeServiceTab('design')}
              aria-label="Design Services"
            >
              Design Services
            </button>
            <button 
              className={`service-slider-tab ${activeServiceTab === 'development' ? 'active' : ''}`}
              onClick={() => changeServiceTab('development')}
              aria-label="Web Development Services"
            >
              Web Development
            </button>
            <button 
              className={`service-slider-tab ${activeServiceTab === 'seo' ? 'active' : ''}`}
              onClick={() => changeServiceTab('seo')}
          ...
          <div className="service-slider-content">
            <div className="service-slider-header">
              <h2 className="service-slider-title">
                {activeServiceTab === 'design' && 'Design Services'}
                {activeServiceTab === 'development' && 'Web Development Services'}
                {activeServiceTab === 'seo' && 'SEO Services'}
              </h2>
              <button 
            ...
            <div className={`service-slider-panel ${activeServiceTab === 'design' ? 'active' : ''}`}>
            ...
            {/* Web Development Services panel */}
            <div className={`service-slider-panel ${activeServiceTab === 'development' ? 'active' : ''}`}>
              <div className="service-slider-items">
                <div className="service-slider-item">
                  <Link 
                ...
                <div className="service-slider-item">
                  <Link 
                    href="/services/webapp-development" 
                    className="service-slider-link"
                    onClick={() => {
                      handleLinkClick('services');
                      closeServiceSlider();
            ...
            {/* SEO Services panel */}
            <div className={`service-slider-panel ${activeServiceTab === 'seo' ? 'active' : ''}`}>
              <div className="service-slider-items">
                <div className="service-slider-item">
                  <Link 
