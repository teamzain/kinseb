...
const WebDevelopmentComponent = () => {
  ...
  // Get style for each service section
  const getServiceStyle = (index) => {
    return {
      ...
      minHeight: isMobile ? 'auto' : isTablet ? '450px' : '500px',
    };
  };
  ...
  // Line style for service divider
  ...
  // Horizontal line style for connecting services
  const getHorizontalLineStyle = (index, color) => {
    // For desktop view: lines above and below the service sections
    const isTop = index === 0 || index === 1;
    const position = isTop ? 'top' : 'bottom';
    const left = index === 0 || index === 2 ? 0 : '25%';
    const width = index === 0 || index === 2 ? '25%' : '25%';
        ...
        {isMobile || isTablet ? (
          <>
            {services.map((service, index) => (
              <div key={service.key} style={getServiceStyle(index)}>
                {isMobile ? (
                  // Mobile layout
                  ...
                  <>
                    ...
                    <div style={getLineStyle(service.color)}>
                      <div style={{
                        position: 'absolute',
                        top: 0,
                        left: '-100%',
          ...
          <div style={{ 
            ...
            {/* Connected Horizontal Lines for Titles */}
            <div style={{ 
              width: '100%', 
              display: 'flex', 
              position: 'relative',
            ...
            {/* Connected Horizontal Lines for Bottom */}
            <div style={{ 
              width: '100%', 
              display: 'flex', 
              position: 'relative',
