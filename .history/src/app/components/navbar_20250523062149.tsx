        ...
        * {
        ...
        @media (min-width: 769px) {
          .menu-open .service-slider {
            left: 400px; /* Start from where menu ends */
            width: calc(100vw - 400px); /* Cover remaining screen */
          }

          .menu-open .service-slider.open {
            left: 400px; /* Keep position when both are open */
          }
        }
        ...
        @media (max-width: 768px) {
          ...
          /* SERVICE SLIDER MOBILE OPTIMIZATIONS - FIXED */
          .service-slider {
            flex-direction: column;
            transition: all 0.6s cubic-bezier(0.16, 1, 0.3, 1);
            /* Ensure it appears above menu but covers only remaining screen */
            z-index: 1001;
            left: 400px; /* Start from where menu ends */
          }

          .service-slider.open {
            left: 0; /* Cover full screen when open */
          }
