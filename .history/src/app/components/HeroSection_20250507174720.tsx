...
const HeroSection = () => {
  ...
  return (
    <div style={{
      position: 'relative',
      width: '100%',
      height: '100vh', // Increased from 91vh to 100vh for taller hero section
      overflow: 'hidden'
    }}>
      {/* Background Video */}
      <video 
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              display: 'flex',
              flexDirection: isMobile ? 'row' : 'row', // Always row to ensure buttons are in one line
              flexWrap: 'nowrap', // Prevent wrapping to keep buttons in one line
              gap: '1rem',
              ...
              <button style={{
                ...
                width: isMobile ? '50%' : 'auto' // Set to 50% width on mobile
              }}
              onMouseOver={(e) => {
