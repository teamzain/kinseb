 ...
 * Modified for full width and reduced height.
 */
  ...
  return (
    <section 
      ...
      style={{
        ...
        padding: '6px 0', // Reduced padding for decreased height
        margin: '0',
        position: 'relative',
    ...
    >
      ...
      <div 
        ...
        style={{
          ...
          padding: '4px 0', // Reduced padding for decreased height
        }}
        ...
        {allTechnologies.map((tech, index) => (
          <div key={index} 
            ...
            style={{
              ...
              margin: '0 clamp(12px, 2vw, 30px)', // Reduced margins
              height: 'clamp(24px, 3vw, 36px)', // Decreased height
          ...
          >
            <tech.Icon 
              style={{
                fontSize: 'clamp(24px, 3vw, 32px)', // Reduced icon size
                color: '#FFFFFF',
      ...
      <style jsx>{`
        ...
        .tech-icon:hover {
          transform: translateY(-4px) scale(1.15); // Reduced hover effect
        }
