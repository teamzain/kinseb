...
const ServiceCard = ({ iconSrc, title, description, hoverImage, animationDelay, isVisible }: ServiceCardProps) => {
  ...
  const handleNavigation = () => {
    const destinationPage = getServiceUrl(title);
...
export default function BusinessServices() {
  ...
  switch (title) {
    ...
    case "Website App Design":
      return "/website-app-design";
    case "Website Redesign":
      return "/website-redesign";
    case "Web Development Ecommerce":
      return "/ecommerce-development";
    case "Web Development Shopify":
      return "/shopify-development";
    case "Website Development Custom":
