...
const WebDesignProcess = () => {
  ...
  // Fix 1: Properly type the refs array to store HTMLDivElement elements
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Fix 2: Add proper null checking and type safety
    ...
    >
      <div style={{ 
        ...
        {processSteps.map((step, index) => (
          <div
            key={index}
            // Fix 3: Correctly use the ref callback pattern for array of refs
