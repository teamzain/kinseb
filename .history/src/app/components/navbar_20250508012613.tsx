      ...
      <div style={{
        ...
        <div style={{
          ...
          <div className="content-container" style={{
            ...
            <h1 className="heading-animation" style={{ fontSize: '56px', marginBottom: '25px', fontWeight: '700', lineHeight: 1.1, textAlign: 'left' }}>
              <div className="first-line" style={{ display: 'block' }}>Building <span style={{ color: '#0099cc' }}>Websites</span> That</div>
              <div className="second-line" style={{ display: 'block' }}>Drive Growth</div>
            </h1>
        ...
        <style jsx global>{`
          ...
          @media (max-width: 360px) {
            ...
            .content-container h1 {
              font-size: 28px !important; /* Slightly smaller font to ensure text fits on small screens */
              text-align: center !important;
            }
            
            /* Ensure heading stays in two lines even on the smallest screens */
            .content-container h1 .first-line,
            .content-container h1 .second-line {
              white-space: nowrap !important;
            }
