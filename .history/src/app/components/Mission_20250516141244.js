...
const SEO_DATA = {
  title: "Our Mission, Vision & Values | Driving Digital Excellence",
  description: "Discover what drives us - our mission to craft clean digital solutions, our vision for digital excellence, and our values built on lasting relationships.",
  keywords: "mission, vision, values, digital solutions, web development, digital excellence",
  canonicalUrl: "/about-us",
  openGraph: {
    type: "website",
    image: "/images/mission.png",
    imageAlt: "Our mission to craft clean digital solutions"
  }
};
  ...
  const cards = [
    {
      ...
      alt: "Team collaborating on digital solutions and website development"
    },
    {
      title: "Vision",
      ...
      alt: "Future of digital excellence and innovation visualization"
    },
    {
      title: "Values",
      ...
      backgroundImage: "/api/placeholder/1302/520", // Using placeholder image
      alt: "Partnership and collaboration in digital project development"
    }
  ];
  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta property="og:type" content={SEO_DATA.openGraph.type} />
        <meta property="og:url" content={SEO_DATA.canonicalUrl} />
        <meta property="og:image" content={SEO_DATA.openGraph.image} />
        <meta property="og:image:alt" content={SEO_DATA.openGraph.imageAlt} />
        
        {/* Twitter Card Meta Tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={SEO_DATA.title} />
        <meta name="twitter:description" content={SEO_DATA.description} />
        <meta name="twitter:image" content={SEO_DATA.openGraph.image} />
      ...
      <section 
        ...
        className="scroll-reveal-section mission-vision-values-section"
      ...
      >
        ...
        >
          {/* Hidden lists for better SEO - all content accessible to search engines */}
          <div className="seo-content" style={{ display: 'none' }} aria-hidden="true">
            <h3>Our Mission, Vision and Values</h3>
            <ul>
              {cards.map((card, index) => (
                <li key={`seo-${index}`}>
                  <h4>{card.title}: {card.heading} {card.accent}</h4>
          ...
          <div 
            ...
            aria-label="Mission, Vision and Values carousel"
          >
            {cards.map((card, index) => (
              <div 
                key={index}
                ...
                aria-label={`${card.title}: ${card.heading} ${card.accent}`}
