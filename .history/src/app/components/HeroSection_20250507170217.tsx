...
export default function HeroSection() {
  // Properly type the ref to be an array of HTMLDivElement references
  const scrollVElements = useRef<(HTMLDivElement | null)[]>([]);
  ...
  useEffect(() => {
    ...
    // Properly type the animation frames array
