    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          {isMobile && (
            <div style={{
              width: '5px',
              height: '100%', // Increased height to cover the full card
              position: 'relative',
              marginRight: '15px',
        ...
        <div style={{
          ...
          position: 'relative', // Added for absolute positioning of connection line
        }}>
          {isMobile && (
            <div style={{
              width: '5px',
              height: '100%', // Increased to full height
              position: 'relative',
              marginRight: '15px',
      ...
      {isMobile && (
        <div style={{
          ...
          {/* This would be where we'd add SVG lines to connect sections if needed */}
        </div>
      )}
