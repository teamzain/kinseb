        ...
        <div style={{
          ...
          <div style={styles.socialIcons}>
            <a href="#" style={styles.iconLink}>
              <img src="/api/placeholder/24/24" alt="Twitter" style={styles.socialIcon} />
            </a>
            <a href="#" style={styles.iconLink}>
              <img src="/api/placeholder/24/24" alt="Facebook" style={styles.socialIcon} />
            </a>
            <a href="#" style={styles.iconLink}>
              <img src="/api/placeholder/24/24" alt="Instagram" style={styles.socialIcon} />
            </a>
            <a href="#" style={styles.iconLink}>
        ...
        <div style={styles.formRow}>
          <div style={styles.inputContainer}>
            <div style={styles.iconContainer}>
              <img src="/api/placeholder/24/24" alt="User Icon" style={styles.inputIcon} />
            </div>
...
const styles: Record<string, CSSProperties> = {
  ...
  leftContent: {
    ...
    height: '100%',
    opacity: 0,
    transform: 'translateX(-100px)', // Increased translation for more dramatic entry
    transition: 'all 0s',
  },
  leftContentTop: {
  ...
  social: {
    marginTop: '-40px', // Moved up from its previous position
    marginBottom: '20px',
  },
  followUs: {
    fontFamily: 'Poppins, sans-serif',
