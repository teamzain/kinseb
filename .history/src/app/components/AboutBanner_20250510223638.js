    ...
    >
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div 
            style={{
              ...
              padding: '6px 16px',
              borderRadius: '30px',
              background: 'rgba(13, 148, 187, 0.1)',
              boxShadow: '0 0 10px rgba(13, 148, 187, 0.3)',
        ...
        <div style={{
          ...
          width: '100%',
          maxWidth: '1200px',
          marginTop: isSmallMobile ? '50px' : isMobile ? '60px' : isTablet ? '100px' : '180px', // Moved up
          ...
          <div 
            ...
            onMouseOver={(e) => {
              ...
              e.currentTarget.style.background = 'rgba(13, 148, 187, 0.1)';
            }}
            onMouseOut={(e) => {
              e.currentTarget.style.transform = 'translateY(0)';
              e.currentTarget.style.boxShadow = '0 4px 15px rgba(0, 0, 0, 0.1)';
              e.currentTarget.style.background = 'rgba(13, 148, 187, 0.05)';
            }}
          >
            <div style={{
          ...
          <div 
            style={{
              ...
              zIndex: 2,
              background: 'rgba(13, 148, 187, 0.15)',
              boxShadow: '0 8px 20px rgba(0, 0, 0, 0.15)',
            }}
            aria-label="Projects delivered counter"
            onMouseOver={(e) => {
              e.currentTarget.style.transform = 'translateY(-23px)';
              e.currentTarget.style.boxShadow = '0 15px 25px rgba(0, 0, 0, 0.25)';
              e.currentTarget.style.background = 'rgba(13, 148, 187, 0.2)';
            }}
            onMouseOut={(e) => {
              e.currentTarget.style.transform = 'translateY(-15px)';
              e.currentTarget.style.boxShadow = '0 8px 20px rgba(0, 0, 0, 0.15)';
              e.currentTarget.style.background = 'rgba(13, 148, 187, 0.15)';
            }}
          >
            <div style={{
            ...
            <div style={{
              ...
              width: '60%',
              height: '4px',
              background: 'linear-gradient(90deg, rgba(13, 148, 187, 0) 0%, rgba(13, 148, 187, 0.7) 50%, rgba(13, 148, 187, 0) 100%)',
              borderRadius: '2px',
              opacity: 0.8,
            }} />
          </div>
