...
const HeroSection = () => {
  ...
  const mobileImages = [
    "/images/mobile-hero-bg-1.jpg",
    "/images/mobile-hero-bg-2.jpg"
  ];
  
  // Current images based on device
  ...
  return (
    <div style={{
      position: 'relative',
      width: '100%',
      height: '91vh', // Increased from 85vh to 91vh for taller hero section
      overflow: 'hidden'
    }}>
      {/* Background Images with tilt */}
      <div 
        ...
        style={{
          ...
          height: '100%',
          zIndex: 0,
          transform: 'rotate(15deg) scale(1.4)', // 15 degree tilt
      ...
      >
        {currentImages.map((image, index) => (
          <img
            ...
            onLoad={index === 0 ? handleImagesLoaded : undefined}
            style={{
              position: 'absolute',
              top: 0,
              left: 0,
      ...
      <div style={{
        ...
        paddingTop: '3rem' // Added padding to move content down
      }}>
        <div style={{
          width: '100%',
          maxWidth: '1280px',
          ...
          <div style={{
            ...
            paddingLeft: '1rem' // Add extra padding to push content more left
          }}>
