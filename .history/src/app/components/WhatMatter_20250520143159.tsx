...
const WhatMattersComponent = () => {
  ...
  const stats = [
    { icon: "/images/people.png", number: "50+", label: "Happy Clients", alt: "Happy clients icon showing people silhouettes" },
    { icon: "/images/45.png", number: "70+", label: "Projects Delivered", alt: "Completed projects icon showing checkmark and documents" },
    { icon: "/images/46.png", number: "98%", label: "Client Satisfaction", alt: "Client satisfaction icon showing star rating" },
    { icon: "/images/47.png", number: "5+", label: "Years of Experience", alt: "Years of experience icon showing calendar" },
  ];
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            'description': 'We build what matters - helping you design smarter, develop faster, and scale better with deep expertise.',
            'aggregateRating': {
              '@type': 'AggregateRating',
              'ratingValue': '4.9',
              'reviewCount': '50'
            },
            'award': 'Client satisfaction rate of 98%'
          })
        }}
      />
        ...
        <figure className={`imageSection ${containerInView ? 'animate-slide-right' : ''}`}>
          <div className="imageWrapper">
            <Image 
              ...
              alt="Professional web design team collaborating on digital projects" 
              width={600} 
              height={750}
              sizes="(max-width: 480px) 300px, (max-width: 768px) 400px, (max-width: 992px) 500px, (max-width: 1200px) 450px, 500px"
              priority={true}
              quality={90}
              className="serviceImage"
            />
          </div>
          <figcaption className="sr-only">Our dedicated team working on web design projects</figcaption>
        </figure>
