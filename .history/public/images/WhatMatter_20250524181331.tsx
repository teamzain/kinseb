  ...
  return (
    ...
    >
        ...
        <figure className={`imageSection ${containerInView ? 'animate-slide-right' : ''}`}>
          <div className="imageWrapper">
            ...
            <Image 
              ...
              priority={true}
              quality={85}
              sizes="(max-width: 480px) 280px, (max-width: 768px) 300px, (max-width: 992px) 350px, 400px"
            />
            ...
            <div className="videoContainer">
              ...
              >
                ...
                <source src="/videos/web.mp4" type="video/webm" />
      ...
      <style jsx>{`
        ...
        /* Video Container - Positioned over the TV screen area */
        .videoContainer {
          position: absolute;
          top: 15%; /* Adjust based on where your TV screen is in the image */
          left: 15%; /* Adjust based on where your TV screen is in the image */
          width: 70%; /* Adjust based on your TV screen size in the image */
          height: 45%; /* Adjust based on your TV screen size in the image */
          border-radius: 4px;
          overflow: hidden;
          z-index: 2;
        }
