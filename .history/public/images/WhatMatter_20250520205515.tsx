...
const WhatMattersComponent = ({ 
  // Make component more reusable with props and default values
  title = "Professional Web Development That Delivers Results",
  highlightedWord = "Build", 
  description = "Whether you're refining an idea or building from scratch, we help you design smarter, develop faster, and scale better. With an agile team, deep expertise, and a commitment to quality—you'll stay focused on what matters most: growth.",
  mainImageSrc = "/images/about-3.png", 
  mainImageAlt = "Professional web development team collaborating on digital solutions",
  sectionId = "what-matters"
}) => {
  // SEO metadata
  const seoTitle = `${title} | Your Company Name`;
  ...
  // Array of stats for easy mapping - enhanced with more semantic data attributes
  const stats = [
    { 
      ...
      dataValue: "50", 
      label: "Happy Clients", 
      alt: "Happy clients icon showing customer satisfaction" 
    },
    { 
      icon: "/images/45.png", 
      number: "70+", 
      ...
      alt: "Completed projects icon showing successful project delivery" 
    },
    { 
      icon: "/images/46.png", 
      number: "98%", 
      ...
      alt: "Client satisfaction icon displaying high satisfaction rating" 
    },
    { 
      icon: "/images/47.png", 
      number: "5+", 
      ...
      alt: "Years of experience icon representing industry experience" 
    },
  ];

  // Function to determine image dimensions based on screen size
  const getImageDimensions = () => {
    // Use different dimensions for mobile devices
  ...
  const [imageDimensions, setImageDimensions] = React.useState({ width: 600, height: 750 });
  ...
  // Generate structured data for this section
  const generateStructuredData = () => {
    const structuredData = {
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://yourwebsite.com/" + sectionId
      }
    };
  ...
  return (
    <>
      ...
      <section 
        ...
        ref={containerRef}
        aria-label="Company achievements and expertise in web development services"
        itemScope
        itemType="https://schema.org/WebPageElement"
      >
        <div className={`contentWrapper ${containerInView ? 'animate-in' : ''}`}>
          <figure 
            className={`imageSection ${containerInView ? 'animate-slide-right' : ''}`}
            itemProp="image"
          >
            <div className="imageWrapper">
              <Image 
                ...
                priority={true}
                quality={85}
                sizes="(max-width: 480px) 280px, (max-width: 768px) 300px, (max-width: 992px) 450px, (max-width: 1200px) 450px, 600px"
                loading="eager"
                itemProp="contentUrl"
              />
            </div>
          ...
          <div 
            className={`textSection ${containerInView ? 'animate-fade-in' : ''}`}
            itemProp="text"
          >
            <h2 className="heading" itemProp="headline">
              We <span className="highlight">{highlightedWord}</span> {title}
            </h2>
            ...
            {/* Add a semantic CTA button */}
            <div className="cta-container">
              <a 
                href="/contact" 
                className="cta-button"
                aria-label="Contact our web development team"
                rel="noopener"
                itemProp="url"
              >
                Start Your Project
        ...
        <style jsx>{`
          ...
          /* DESKTOP IMAGE STYLES (1200px and above) */
          .imageSection {
            width: 50%;
            position: relative;
          ...
          .cta-button:hover {
            ...
            box-shadow: 0 6px 18px rgba(13, 152, 186, 0.4);
          }
          ...
          @media (max-width: 768px) {
            ...
            /* IMAGE STYLES FOR SMALL TABLET / LARGE MOBILE */
            .imageSection {
              width: 100%;
              max-width: 100%;
              padding: 0 20px;
