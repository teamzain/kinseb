  ...
  return (
    ...
    >
      <div className={`contentWrapper ${containerInView ? 'animate-in' : ''}`}>
        <figure className={`tvSection ${containerInView ? 'animate-slide-right' : ''}`}>
          <div className="tvWrapper">
            {/* TV Frame */}
            <div className="tvFrame">
              {/* TV Screen with Video */}
              ...
              <div className="tvStand">
                <div className="standBase"></div>
                <div className="standNeck"></div>
              </div>
            </div>
