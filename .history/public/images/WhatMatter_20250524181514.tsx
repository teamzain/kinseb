  ...
  return (
    ...
    >
      ...
      <style jsx>{`
        ...
        .videoContainer {
          position: absolute;
          top: 5%; /* Adjust based on where your TV screen is in the image */
          left: 5%; /* Adjust based on where your TV screen is in the image */
          width: 100%; /* Adjust based on your TV screen size in the image */
          height: 65%; /* Adjust based on your TV screen size in the image */
          border-radius: 4px;
          overflow: hidden;
          z-index: 2;
        }
